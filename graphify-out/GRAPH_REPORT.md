# Graph Report - CodeRunner  (2026-06-12)

## Corpus Check
- 2517 files · ~2,093,337 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21543 nodes · 41312 edges · 2109 communities (1482 shown, 627 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6466e321`
...
1. `main()` - 792 edges
2. `Robot()` - 710 edges
3. `TeleopPeriodic()` - 276 edges
4. `RobotPeriodic()` - 264 edges
5. `DisabledInit()` - 228 edges
6. `TeleopInit()` - 228 edges
7. `AutonomousInit()` - 204 edges
8. `AutonomousPeriodic()` - 204 edges
9. `TestPeriodic()` - 204 edges
10. `DriveSubsystem` - 195 edges

## Surprising Connections (you probably didn't know these)
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_5bbe962f834f78ee001487aa1723e2c2/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_5bbe962f834f78ee001487aa1723e2c2/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_5bbe962f834f78ee001487aa1723e2c2/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_5bbe962f834f78ee001487aa1723e2c2/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
...
## Communities (2109 total, 627 thin omitted)
...
Cohesion: 0.01
Nodes (8): Command, DriveDistance, DriveTime, DriveToPoseCommand, TurnDegrees, m_autoTime(), RetractIntakeCommand, SysIdRoutineBot

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (347): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession (+339 more)
...
Cohesion: 0.02
Nodes (170): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+162 more)
...
Cohesion: 0.07
Nodes (111): BranchCoverage, Breakpoint, CallHierarchyIncomingCall, CallHierarchyItem, CallHierarchyOutgoingCall, CancellationError, CancellationTokenSource, ChatRequestTurn (+103 more)
...
Cohesion: 0.03
Nodes (59): first, NUM_RUNS, second, bashCalls, cloneCall, ctx, importer, mock (+51 more)
...
Cohesion: 0.05
Nodes (47): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+39 more)
...
Cohesion: 0.03
Nodes (11): DriveIOTalonFX, DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIOTalonFX, SuperstructureIO, TurretIO (+3 more)
...
Cohesion: 0.05
Nodes (46): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+38 more)
...
Cohesion: 0.05
Nodes (45): ConsolePane(), ConsolePaneProps, Avatar(), InitialsAvatar(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES (+37 more)
...
Cohesion: 0.06
Nodes (34): sendUpstreamWebSocketMessage(), AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, LessonLoadSocketData (+26 more)
...
Cohesion: 0.04
Nodes (41): 0.1.0 - 2017-12-01, 0.22.4, 0.30.0, 0.30.1, 0.31.0, 0.31.1, 0.31.3, 0.35.2 (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (41): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.3 (+39 more)
...
Cohesion: 0.07
Nodes (4): FlywheelIO, HoodIOSim, HoodIO, ShooterSubsystem
...
Cohesion: 0.08
Nodes (34): ANSI, colorize(), configureLogging(), createJsonSink(), createSink(), defaultLogFormat(), formatAttrs(), formatAttrValue() (+26 more)
...
Cohesion: 0.1
Nodes (25): containerName(), ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor() (+17 more)
...
Cohesion: 0.12
Nodes (3): LocalDockerRuntimeProvider, runtimeFromLease(), workspaceHomePath()

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (3): FlywheelIOSpark, SuperstructureIOSpark, TurretIOSpark
...
Cohesion: 0.06
Nodes (35): 10. Promote yourself to admin, 1. Create and configure the GCP project, 2. Create the Terraform state bucket, 3. Configure Terraform variables, 4. Apply Terraform, 5. Populate Secret Manager, 6. Add a DNS A record, 7. Reset the VM to render config (+27 more)
...
Cohesion: 0.13
Nodes (4): ContainerOrchestrator, portIsFree(), simContainerName(), workspaceJdtLsDataPath()
...
Cohesion: 0.07
Nodes (29): Adding an entry, Admin API break-glass, Audit log, Between sessions, Checking and adjusting the cap at runtime, code:bash (bun run start), code:bash (# Remove all entries before a date), code:bash (# Overall system status: workspaces, container states, activ) (+21 more)
...
Cohesion: 0.12
Nodes (27): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App, 5. Configuration, 6. Backup and Restore (+19 more)
...
Cohesion: 0.08
Nodes (5): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer

### Community 174 - "Community 174"
Cohesion: 0.09
Nodes (24): Alloy config location, Authentication, Capturing a session on a local deployment, code:block1 (14:23:01.482 INFO  [control.runs]  run started workspaceId=a), code:json ({"timestamp":"2026-05-21T14:23:01.482Z","level":"info","cate), code:bash (bun run start 2>&1 | tee coderunner-$(date +%Y%m%d).log), code:bash (# Manual probe), code:bash (curl http://localhost:4000/healthz) (+16 more)
...
Cohesion: 0.09
Nodes (21): 1. Clone and set up the repo, 2. Create your `.env` file, 3. Build the workspace image and web assets, 4. Allowlist who can sign in, 5. Start the app, 6. Promote the first admin, A note on plain HTTP, code:bash (git clone https://github.com/mathewdunne/CodeRunner.git Code) (+13 more)
...
Cohesion: 0.1
Nodes (20): Build times out, code:bash (# Confirm Docker is running), code:bash (sudo systemctl restart coderunner), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (RUN_BUILD_TIMEOUT_MS=180000), code:bash (SIM_STARTUP_TIMEOUT_MS=60000), code:bash (docker logs coderunner-workspace-<workspaceId> --tail 100), code:bash (bun run allowlist:list) (+12 more)
...
Cohesion: 0.21
Nodes (3): codeContainerName(), dockerError(), dockerPortBindError()
...
Cohesion: 0.12
Nodes (16): Alloy config location, code:block1 (https://prometheus-prod-XX-prod-us-central-0.grafana.net/api), code:block2 (https://logs-prod-XXX.grafana.net/loki/api/v1/push), code:bash (echo -n 'https://prometheus-prod-XX-prod-us-central-0.grafan), code:bash (gcloud compute ssh coderunner --zone=us-central1-a --tunnel-), code:bash (sudo systemctl status alloy), code:logql (# All logs from one student), code:promql (up{instance="coderunner"}) (+8 more)
...
Cohesion: 0.12
Nodes (15): Admin and Metrics, Auth and OAuth, code:bash (bun run start -- --demo), Configuration Reference, Demo mode and the `--demo` flag, Docker and Containers, .env.example vs config.ts — notes, How environment is loaded (+7 more)
...
Cohesion: 0.17
Nodes (16): code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/) (+8 more)
...
Cohesion: 0.13
Nodes (14): Backup options, Backups, code:bash (bun run backup), code:block2 (data/backups/2026-05-16-151038/), code:bash (# Write the backup to a custom location), code:bash (bun run restore -- <backup-dir>), code:bash (# Preview what would be restored without writing anything), code:bash (# On the source machine, stop the control plane and create a) (+6 more)
...
Cohesion: 0.14
Nodes (13): Building the image locally, code:bash (bun run docker:build:workspace), code:block2 (docker build -f containers/code/Dockerfile -t coderunner-wor), code:bash (bun run docker:pull:workspace), code:bash (bun run docker:push:workspace), code:bash (bun run docker:rebuild-workspaces), code:bash (bun run docker:rebuild-workspaces -- --dry-run), Image size (+5 more)
...
Cohesion: 0.15
Nodes (12): About demo mode, code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (bun install), code:bash (bun run setup:demo), code:bash (bun run demo), Platform support, Prerequisites, Quick Start (+4 more)

### Community 488 - "Community 488"
Cohesion: 0.15
Nodes (12): Admin role, Audit log, Authentication, code:json ({), Container isolation, Demo mode, Email allowlist, Per-workspace access enforcement (+4 more)
...
Cohesion: 0.2
Nodes (9): Backup and Restore, Build, CLI Reference, Database, Docker Images and Containers, Docs Site, Quality and Tests, Running the App (+1 more)
...
Cohesion: 0.29
Nodes (6): UserMenu(), ImportState, ImportStatus, INITIAL_STATE, useImport(), UseImportReturn
...
## Knowledge Gaps
- **4866 isolated node(s):** `nosniff`, `console`, `cookie`, `consoleErrors`, `leaseErrors` (+4861 more)
...
- **Why does `Robot` connect `Community 55` to `Community 0`, `Community 35`, `Community 50`, `Community 347`, `Community 731`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 91` to `Community 50`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 35` to `Community 43`, `Community 18`, `Community 27`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **What connects `nosniff`, `console`, `cookie` to the rest of the system?**
