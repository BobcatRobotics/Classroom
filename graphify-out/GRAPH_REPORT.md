...
## Corpus Check
- 988 files · ~709,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25657 nodes · 48643 edges · 2569 communities (1824 shown, 745 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 446 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11475da3`
...
## Communities (2569 total, 745 thin omitted)
...
Cohesion: 0.0
Nodes (10): Command, DriveDistance, DriveTime, DriveToPoseCommand, TurnTime, RobotContainer, RobotContainer, m_autoTime() (+2 more)
...
Cohesion: 0.01
Nodes (204): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+196 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (13): ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand, InstantCommand, ReplaceMeInstantCommand (+5 more)
...
Cohesion: 0.02
Nodes (12): DoubleSupplier, DriveIOSpark, ModuleIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, SpindexerIOSpark, Drive (+4 more)
...
Cohesion: 0.02
Nodes (13): DriveIOTalonFX, DriveIOTalonSRX, DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIOTalonFX, SuperstructureIOTalonSRX (+5 more)
...
Cohesion: 0.06
Nodes (80): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+72 more)
...
Cohesion: 0.04
Nodes (47): DemoBanner(), Topbar(), patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers(), UseAutoChoosersReturn (+39 more)
...
Cohesion: 0.07
Nodes (4): FlywheelIO, HoodIO, ShooterSubsystem, AimHoodAndSpinFlywheelCommand

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+33 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+41 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.1, 0.31.3, 0.35.2 (+31 more)
...
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.30.0, 0.30.1, 0.31.1, 0.31.3, 0.35.1 (+39 more)
...
Cohesion: 0.11
Nodes (16): Autonomous(), Disabled(), EndCompetition(), StartCompetition(), Teleop(), Test(), Args, backupDatabase() (+8 more)
...
Cohesion: 0.06
Nodes (29): sendUpstreamWebSocketMessage(), AppSocket, log, WebSocketHandlerContext, BundledCatalogSource, CatalogManifest, CatalogSource, createCatalogSource() (+21 more)
...
Cohesion: 0.06
Nodes (27): BINDING_GROUPS, bp(), Bumper(), bv(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+19 more)
...
Cohesion: 0.08
Nodes (26): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS (+18 more)
...
Cohesion: 0.09
Nodes (26): CodeContainerStatus, containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), dockerError(), DockerInspectContainer, isLoopbackHost(), labelsMatch() (+18 more)
...
Cohesion: 0.07
Nodes (29): 0.10.1, 0.21.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1, 0.26.2 (+20 more)

### Community 152 - "Community 152"
Cohesion: 0.07
Nodes (27): 0.10.2, 0.18.7, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.13
Nodes (25): 10. Host Sizing, 11. Lessons and Project Import, 11. Project Import, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App (+17 more)
...
Cohesion: 0.14
Nodes (18): 5. Configuration, code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m) (+10 more)
...
Cohesion: 0.24
Nodes (3): containerRuntimeState(), workspaceHomePath(), workspaceJdtLsDataPath()
...
- **745 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 60` to `Community 0`, `Community 39`, `Community 815`, `Community 656`, `Community 274`, `Community 52`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 88` to `Community 65`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 91` to `Community 52`?**
