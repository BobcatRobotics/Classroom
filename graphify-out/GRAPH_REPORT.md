...
## Corpus Check
- 2517 files · ~2,094,567 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21556 nodes · 41337 edges · 2169 communities (1489 shown, 680 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac993522`
...
## Communities (2169 total, 680 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (4): main(), Robot(), shootTrigger(), TimedRobot

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (5): Command, DriveToPoseCommand, m_autoTime(), RapidReactCommandBot, SysIdRoutineBot
...
Cohesion: 0.02
Nodes (177): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+169 more)
...
Cohesion: 0.03
Nodes (8): Main, Main, RobotBase, Main, Main, Main, Main, Main
...
Cohesion: 0.04
Nodes (90): AdminRouteContext, log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest, contentTypeFor() (+82 more)
...
Cohesion: 0.03
Nodes (9): DoubleSupplier, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, Drive, TurretIOSpark (+1 more)
...
Cohesion: 0.05
Nodes (52): ConsolePane(), ConsolePaneProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel() (+44 more)
...
Cohesion: 0.05
Nodes (49): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+41 more)
...
Cohesion: 0.04
Nodes (41): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.27.0, 0.30.0, 0.31.0, 0.31.1, 0.35.2, 0.37.1 (+33 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (41): 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)
...
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.31.1, 0.31.3 (+39 more)
...
Cohesion: 0.06
Nodes (5): RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, ShiftChangeRumbleLEDCommand, ParallelDeadlineGroup

### Community 59 - "Community 59"
Cohesion: 0.11
Nodes (6): codeContainerName(), defaultDockerRunner(), LocalDockerRuntimeProvider, runDockerCli(), runtimeFromLease(), v2LabelsMatch()
...
Cohesion: 0.09
Nodes (33): handleAdminRoute(), adminStatusResponse(), auditActor(), addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist() (+25 more)
...
Cohesion: 0.07
Nodes (25): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS (+17 more)
...
Cohesion: 0.13
Nodes (3): ContainerOrchestrator, portIsFree(), workspaceJdtLsDataPath()
...
Cohesion: 0.07
Nodes (27): 0.18.9, 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.12
Nodes (22): containerName(), ContainerOrchestratorOptions, DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor(), leasePortFor(), leaseStateFor() (+14 more)
...
Cohesion: 0.14
Nodes (24): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup (+16 more)
...
Cohesion: 0.24
Nodes (4): containerRuntimeState(), dockerError(), dockerPortBindError(), workspaceHomePath()
...
## Knowledge Gaps
- **4872 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+4867 more)
...
- **Why does `Robot` connect `Community 41` to `Community 72`, `Community 0`, `Community 370`, `Community 134`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 32` to `Community 16`, `Community 19`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `Vision` connect `Community 655` to `Community 186`, `Community 3`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _4872 weakly-connected nodes found - possible documentation gaps or missing edges._
