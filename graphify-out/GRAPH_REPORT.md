...
## Corpus Check
- 1023 files · ~769,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22815 nodes · 44127 edges · 2233 communities (1576 shown, 657 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ae88b34`
...
## Communities (2233 total, 657 thin omitted)
...
Cohesion: 0.0
Nodes (11): Command, ReplaceMeCommand, ArcadeDrive, DriveDistance, DriveToPoseCommand, m_autoTime(), RapidReactCommandBot, ShootIfReadyCommand (+3 more)
...
Cohesion: 0.02
Nodes (183): AppSocket, ControlAppOptions, createApp(), AuditLogEntry, DockerRunner, RunCommandFactory, adminCookie, body (+175 more)
...
Cohesion: 0.03
Nodes (102): handleUploadAsset(), userAssetsPath(), getDemoSession(), getDemoSessionResponseBody(), seedDemoUser(), getSessionFromRequest(), requireAdmin(), requireSession() (+94 more)
...
Cohesion: 0.03
Nodes (75): sendUpstreamWebSocketMessage(), createWebSocketHandlers(), log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (63): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints(), defaultDockerRunner(), dockerError(), dockerPortBindError() (+55 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (85): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange (+77 more)
...
Cohesion: 0.04
Nodes (43): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+35 more)
...
Cohesion: 0.04
Nodes (7): DoubleSupplier, KickerIOSpark, RollerIOSpark, SpindexerIOSpark, Drive, SparkUtil, TunableDouble
...
Cohesion: 0.05
Nodes (42): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+34 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.34.0 - 2021-05-26 (+33 more)
...
Cohesion: 0.04
Nodes (39): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.27.0, 0.30.0, 0.30.1, 0.31.1, 0.35.1 (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.31.3 (+39 more)
...
Cohesion: 0.07
Nodes (18): Listener, FakeWebSocket, setupBridgeAndSocket(), FakeWebSocket, announceChooser(), body, controlled, cookie (+10 more)
...
Cohesion: 0.17
Nodes (5): ArmSimulationTest, TEST_P(), SwerveControllerCommandTest, TEST_F(), Thread
...
Cohesion: 0.07
Nodes (28): 0.18.5, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 129 - "Community 129"
Cohesion: 0.07
Nodes (27): 0.18.7, 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.08
Nodes (4): FlywheelIOSpark, FlywheelIO, HoodIOSim, HoodIO
...
Cohesion: 0.11
Nodes (23): 6. Backup and Restore, code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m) (+15 more)
...
- **Why does `Robot` connect `Community 60` to `Community 0`, `Community 33`, `Community 133`, `Community 168`, `Community 176`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 84` to `Community 168`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 33` to `Community 17`, `Community 19`, `Community 23`?**
