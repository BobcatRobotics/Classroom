...
## Corpus Check
- 2519 files · ~2,096,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21589 nodes · 41390 edges · 2078 communities (1479 shown, 599 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48c12802`
...
## Communities (2078 total, 599 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (50): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+42 more)
...
Cohesion: 0.01
Nodes (8): Command, ReplaceMeCommand, DriveDistance, DriveTime, DriveToPoseCommand, TurnTime, m_autoTime(), SysIdRoutineBot
...
Cohesion: 0.02
Nodes (188): AppSocket, ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+180 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (17): RobotContainer, RobotContainer, RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch (+9 more)
...
Cohesion: 0.02
Nodes (13): DoubleSupplier, DriveIOSpark, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark (+5 more)
...
Cohesion: 0.03
Nodes (98): handleUploadAsset(), userAssetsPath(), getDemoSession(), getDemoSessionResponseBody(), seedDemoUser(), getSessionFromRequest(), requireAdmin(), requireSession() (+90 more)
...
Cohesion: 0.05
Nodes (90): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+82 more)
...
Cohesion: 0.02
Nodes (82): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, AuthProvider (+74 more)
...
Cohesion: 0.05
Nodes (45): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+37 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (42): BINDING_GROUPS, bp(), Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+34 more)
...
Cohesion: 0.06
Nodes (40): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+32 more)
...
Cohesion: 0.05
Nodes (35): DemoBanner(), EditorPane(), EditorPaneProps, patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers() (+27 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (32): AdminLayout(), Tab, tabs, SimControls(), SimControlsProps, useAdminPoll(), Allowlist(), AllowlistData (+24 more)
...
Cohesion: 0.04
Nodes (41): 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+33 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)
...
Cohesion: 0.05
Nodes (5): DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIO
...
Cohesion: 0.08
Nodes (34): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), removeAllowlistEntry(), saveAllowlist() (+26 more)
...
Cohesion: 0.07
Nodes (31): first, NUM_RUNS, parsed, slugArb, allianceStationSchema, authProvidersResponseSchema, autoChooserPatchSchema, autoChoosersResponseSchema (+23 more)
...
Cohesion: 0.07
Nodes (28): 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)

### Community 126 - "Community 126"
Cohesion: 0.07
Nodes (27): 0.10.2, 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.11
Nodes (4): RobotContainer, RobotContainer, RobotContainer, RobotContainer
...
- **Why does `Robot` connect `Community 60` to `Community 0`, `Community 37`, `Community 360`, `Community 137`, `Community 307`, `Community 732`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 34` to `Community 15`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 96` to `Community 360`?**
