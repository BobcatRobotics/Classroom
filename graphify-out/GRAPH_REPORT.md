# Graph Report - /home/matt/dev/CodeRunner  (2026-09-03)

## Corpus Check
- Large corpus: 1235 files · ~777,280 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 26083 nodes · 49215 edges · 2597 communities (1861 shown, 736 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 487 edges (avg confidence: 0.81)
- Token cost: 209,081 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_WPILib Robot Examples (vendored)|WPILib Robot Examples (vendored)]]
- [[_COMMUNITY_WPILib C++ Robot Mains (vendored)|WPILib C++ Robot Mains (vendored)]]
- [[_COMMUNITY_WPILib Command Classes (vendored)|WPILib Command Classes (vendored)]]
- [[_COMMUNITY_VS Code API Declarations|VS Code API Declarations]]
- [[_COMMUNITY_VS Code Authentication API Types|VS Code Authentication API Types]]
- [[_COMMUNITY_WPILib Subsystem Headers (vendored)|WPILib Subsystem Headers (vendored)]]
- [[_COMMUNITY_Robot Mode Lifecycle Hooks|Robot Mode Lifecycle Hooks]]
- [[_COMMUNITY_Control Plane Tests|Control Plane Tests]]
- [[_COMMUNITY_WPILib Autonomous Commands (vendored)|WPILib Autonomous Commands (vendored)]]
- [[_COMMUNITY_WPILib C++ Entry Points (vendored)|WPILib C++ Entry Points (vendored)]]
- [[_COMMUNITY_Student Robot Subsystems (workspace)|Student Robot Subsystems (workspace)]]
- [[_COMMUNITY_VS Code Extension Changelogs|VS Code Extension Changelogs]]
- [[_COMMUNITY_VS Code Extension Changelogs|VS Code Extension Changelogs]]
- [[_COMMUNITY_VS Code Extension Changelogs|VS Code Extension Changelogs]]
...
- [[_COMMUNITY_Local Deploy & Acceptance Checks|Local Deploy & Acceptance Checks]]
...
- [[_COMMUNITY_PathPlanner Integration|PathPlanner Integration]]
...
- [[_COMMUNITY_GCloud Deployment Steps|GCloud Deployment Steps]]
...
- [[_COMMUNITY_Install & Upgrade Runbooks|Install & Upgrade Runbooks]]
...
- [[_COMMUNITY_Repo Overview & Dev Commands|Repo Overview & Dev Commands]]
...
- [[_COMMUNITY_Day-to-Day Operations|Day-to-Day Operations]]
...
1. `main()` - 924 edges
2. `Robot()` - 828 edges
3. `TeleopPeriodic()` - 322 edges
4. `RobotPeriodic()` - 308 edges
5. `DisabledInit()` - 266 edges
6. `TeleopInit()` - 266 edges
7. `AutonomousInit()` - 238 edges
8. `AutonomousPeriodic()` - 238 edges
9. `TestPeriodic()` - 238 edges
10. `DisabledPeriodic()` - 224 edges

## Surprising Connections (you probably didn't know these)
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0/document/_java.learnMoreAboutRefactorings.md
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0/document/_java.learnMoreAboutRefactorings.md
- `Non-Destructive Gradle Init Script` --semantically_similar_to--> `HALSIM_EXTENSIONS Empty on Later Run (log)`  [INFERRED] [semantically similar]
  docs/lessons/team-import.md → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/wpilib/2026/logs/wpilibtoollog.txt
- `PathPlanner Overview Screenshot` --references--> `docs/using-pathplanner.md`  [INFERRED]
  website/static/img/screenshots/pathplanner-overview.png → docs/using-pathplanner.md

## Hyperedges (group relationships)
- **PathPlanner File Read/Write and Troubleshooting** — using_coderunner_pathplanner, architecture_pathplanner_file_api, faq_pathplanner_save_location, troubleshooting_pathplanner_missing [INFERRED 0.85]
- **Run/Simulate Lifecycle (Build, HALSim, NT4, Driver Station)** — architecture_run_pipeline, architecture_halsim, architecture_nt4, using_coderunner_driver_station [INFERRED 0.85]
- **Cloud Deployment Environment Configuration Pipeline** — configuration_docker_compose_deployment, gcloud_secret_manager, gcloud_render_env_script, configuration_env_loading [INFERRED 0.80]

## Communities (2597 total, 736 thin omitted)

### Community 0 - "WPILib Robot Examples (vendored)"
Cohesion: 0.0
Nodes (52): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+44 more)

### Community 1 - "WPILib C++ Robot Mains (vendored)"
Cohesion: 0.01
Nodes (3): main(), Robot(), shootTrigger()

### Community 2 - "WPILib Command Classes (vendored)"
Cohesion: 0.01
Nodes (6): Command, ArcadeDrive, DriveToPoseCommand, TurnDegrees, m_autoTime(), SysIdRoutineBot

### Community 3 - "VS Code API Declarations"
Cohesion: 0.05
...
### Community 4 - "VS Code Authentication API Types"
Cohesion: 0.0
Nodes (458): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession (+450 more)

### Community 5 - "WPILib Subsystem Headers (vendored)"
Cohesion: 0.01
Nodes (7): ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), log(), SubsystemBase()

### Community 6 - "Robot Mode Lifecycle Hooks"
Cohesion: 0.05
...
### Community 7 - "Control Plane Tests"
Cohesion: 0.01
Nodes (219): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+211 more)

### Community 8 - "WPILib Autonomous Commands (vendored)"
Cohesion: 0.01
Nodes (6): AutonomousDistance, AutonomousTime, ComplexAuto, DriveToClimbPoseSequentialCommand, SequentialCommandGroup, AgitateIntakeCommand

### Community 10 - "Student Robot Subsystems (workspace)"
Cohesion: 0.02
Nodes (14): DoubleSupplier, DriveIOSpark, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, TurretCommands (+6 more)

### Community 11 - "VS Code Extension Changelogs"
Cohesion: 0.01
...
### Community 12 - "VS Code Extension Changelogs"
Cohesion: 0.01
Nodes (167): 0.0.10 (February 08th, 2017), 0.0.11 (March 2nd, 2017), 0.0.12 (March 16th, 2017), 0.0.13 (March 17th, 2017), 0.0.1 (September 12, 2016), 0.0.2 (September 14th, 2016), 0.0.3 (September 16th, 2016), 0.0.4 (September 26th, 2016) (+159 more)

### Community 13 - "VS Code Extension Changelogs"
Cohesion: 0.01
Nodes (167): 0.0.10 (February 08th, 2017), 0.0.11 (March 2nd, 2017), 0.0.12 (March 16th, 2017), 0.0.13 (March 17th, 2017), 0.0.1 (September 12, 2016), 0.0.2 (September 14th, 2016), 0.0.3 (September 16th, 2016), 0.0.4 (September 26th, 2016) (+159 more)
...
Cohesion: 0.03
Nodes (86): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+78 more)
...
Cohesion: 0.03
Nodes (78): sendUpstreamWebSocketMessage(), log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls, cloneCall (+70 more)
...
Cohesion: 0.03
Nodes (99): handleUploadAsset(), userAssetsPath(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), After, Before, code:java (public class Foo {) (+91 more)
...
Cohesion: 0.05
Nodes (95): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+87 more)
...
Cohesion: 0.04
Nodes (43): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+35 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (14): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer (+6 more)
...
Cohesion: 0.02
Nodes (86): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, AuthProvider (+78 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (73): toHostPath(), ControlConfig, ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange (+65 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (51): ConsolePane(), ConsolePaneProps, Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps (+43 more)
...
Cohesion: 0.04
Nodes (9): DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIOTalonFX, SuperstructureIO, TurretIO, VisionIO (+1 more)
...
Cohesion: 0.05
Nodes (38): DemoBanner(), EditorPane(), EditorPaneProps, patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers() (+30 more)
...
Cohesion: 0.05
Nodes (41): BINDING_GROUPS, bp(), Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton() (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (4): OuttakeCommand, IntakeCommand, IntakeControlCommand, ShootIfReadyCommand
...
### Community 53 - "Local Deploy & Acceptance Checks"
Cohesion: 0.05
Nodes (52): 1. Find your host IP, 1. Login And Isolation, 1. Login, Project Picker, And Isolation, 2. Editor And Project Persistence, 2. Start the control plane, 3. Connect from other machines, 3. File Operations, 4. Firewall (if needed) (+44 more)
...
Cohesion: 0.09
Nodes (31): AdminApp(), AdminLayout(), Tab, tabs, useAdminPoll(), Allowlist(), AllowlistData, AuditEntry (+23 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+31 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (41): 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.31.0 (+41 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.22.2, 0.27.0, 0.30.1, 0.31.0, 0.31.1, 0.31.3, 0.33.1 (+31 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.1, 0.31.0 (+39 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (6): ax(), bv(), FlywheelIOSim, HoodIOSim, clamp(), TurretIOSim

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.30.1 (+39 more)
...
### Community 66 - "PathPlanner Integration"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (31): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+23 more)
...
Cohesion: 0.07
Nodes (34): PANEL_IDS, SimPanePanels(), SimPanePanelsProps, SimPaneSwitcher(), SimPaneSwitcherProps, SimPaneTab, SimPaneTabs(), SimPaneTabSelector() (+26 more)
...
Cohesion: 0.05
Nodes (3): GyroIONavX, ModuleIOSpark, SparkOdometryThread
...
### Community 89 - "GCloud Deployment Steps"
Cohesion: 0.06
Nodes (38): 10. Become the first admin, 10. Promote yourself to admin, 1. Create and configure the GCP project, 2. Create the Terraform state bucket, 3. Configure Terraform variables, 4. Apply Terraform, 5. Populate Secret Manager, 6. Add a DNS A record (+30 more)
...
Cohesion: 0.05
Nodes (37): admin/allowlist-management.spec.ts, admin/audit-log.spec.ts, admin/capacity-cap.spec.ts, admin/user-management.spec.ts, admin/workspace-backup-restore.spec.ts, auth/allowlist.spec.ts, auth/login.spec.ts, auth/roles.spec.ts (+29 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (28): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, onSetEnabled, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS (+20 more)
...
Cohesion: 0.06
Nodes (24): 0.10.0, 0.11.0, 0.11.1, 0.11.2, 0.11.3, 0.12.0, 0.12.1, 0.13.0 (+16 more)
...
Cohesion: 0.06
Nodes (26): 0.10.0, 0.11.0, 0.11.1, 0.11.2, 0.11.3, 0.12.0, 0.12.1, 0.13.0 (+18 more)
...
### Community 107 - "Install & Upgrade Runbooks"
Cohesion: 0.09
Nodes (34): 1. Choose the new version, 1. Clone and configure, 1. Clone and set up the repo, 1. Clone the repo, 2. Create your `.env` file, 2. Pull the new images and restart the control plane, 2. Start and verify, 3. Build the workspace image and web assets (+26 more)
...
Cohesion: 0.08
Nodes (24): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+16 more)
...
### Community 132 - "Repo Overview & Dev Commands"
Cohesion: 0.1
Nodes (31): code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (cd website && bun install && bun run start), code:bash (bun run docs:dev), code:bash (bun run dev:control   # Bun control plane on :4000 with --wa), code:bash (bun run verify        # typecheck + Bun tests + Vitest + Pla), CodeRunner, Commands, Development (+23 more)

### Community 133 - "Community 133"
Cohesion: 0.08
Nodes (17): ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState, useTheme() (+9 more)
...
Cohesion: 0.06
Nodes (23): 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
### Community 147 - "Day-to-Day Operations"
Cohesion: 0.07
Nodes (29): Adding an entry, Admin API break-glass, Audit log, Between sessions, Checking and adjusting the cap at runtime, code:bash (docker compose exec control coderunner <subcommand> <args>), code:bash (# Remove all entries before a date), code:bash (# Overall system status: workspaces, container states, activ) (+21 more)

### Community 148 - "Community 148"
Cohesion: 0.07
Nodes (29): 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+21 more)
...
Cohesion: 0.07
Nodes (11): 01 - Hello, World, Bonus, Intentional Template Contents, Kitbot Controls, Provenance, Robot Starter, Running it, Steps (+3 more)
...
Cohesion: 0.07
Nodes (28): 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)

### Community 153 - "Community 153"
Cohesion: 0.07
Nodes (27): 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)

### Community 154 - "Community 154"
Cohesion: 0.07
Nodes (29): Bonus, Bonus, Bonus, Bonus, Bonus, Bonus, Bonus, Bonus (+21 more)
...
Cohesion: 0.07
Nodes (27): 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.11
Nodes (17): seedRuntimeMissing(), seedRuntimeRunning(), snapshot, cookie, snapshot, console, cookie, makeScriptedRunCommandFactory() (+9 more)
...
Cohesion: 0.09
Nodes (25): Alloy config location, Authentication, Capturing a session, Capturing a session on a local deployment, code:block1 (14:23:01.482 INFO  [control.runs]  run started workspaceId=a), code:json ({"timestamp":"2026-05-21T14:23:01.482Z","level":"info","cate), code:bash (docker compose logs -f control | tee coderunner-$(date +%Y%m), code:bash (# Manual probe) (+17 more)

### Community 189 - "Community 189"
Cohesion: 0.08
Nodes (25): 0.10.0, 0.11.0, 0.12.0, 0.12.1, 0.1.0, 0.28.0, 0.29.0, 0.2.0 (+17 more)

### Community 190 - "Community 190"
Cohesion: 0.08
Nodes (25): 10. Phased implementation plan, 11. Deferred / future optimizations, 1. Goal, 2. Locked decisions, 3. Current state (what we're changing), 3. Pre-implementation state (what changed), 4.1 Manifest (`modules.json`), 4.2 Per-module run config (+17 more)

### Community 191 - "Community 191"
Cohesion: 0.13
Nodes (25): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App, 5. Configuration, 8. Monitoring (+17 more)
...
Cohesion: 0.1
Nodes (12): Additional Freetype Attributions, code:block1 (FreeType comes with two licenses from which you can choose t), code:block2, code:block3 (GNU GENERAL PUBLIC LICENSE), code:block4, code:block5, FreeType License, FreeType Notice (+4 more)

### Community 213 - "Community 213"
Cohesion: 0.18
Nodes (24): code:bash (# Container is auto-recreated on next run. If persistent:), code:bash (# Restart the code container), code:bash (bun run dev:control), code:bash (bun run migrate:status  # verify DB is accessible), code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (CODE_MEMORY_LIMIT=2048m) (+16 more)
...
Cohesion: 0.09
Nodes (22): 0. Pre-flight + safety snapshot, 1. Stage the cutover script, 2. Run the cutover, 3. Verify, 4. Make reboots durable (gcloud-only), 5. Converging to the full model, 6. Rollback, code:bash (export VM=coderunner) (+14 more)
...
Cohesion: 0.09
Nodes (21): code:ts (this.storage.updateRunJob(update);), code:ts (start(workspace: WorkspaceRow, connection?: RunConnection | ), code:ts (private isCurrentJob(job: RunJob): boolean {), code:ts (if (this.isCurrentJob(job)) {), code:ts (this.storage.updateRunJob(update);), Commands you will need, Current state, Done criteria (+13 more)

### Community 224 - "Community 224"
Cohesion: 0.09
Nodes (21): code:ts (if (suffix === "/ws/run" && request.method === "GET") {), code:ts (export type BunUpgradeServer = {), code:ts (if (suffix === "/ws/run" && request.method === "GET") {), code:ts (if (suffix === "/ws/gamepad" && request.method === "GET") {), code:ts (if (suffix === "/ws/lesson-load" && request.method === "GET"), code:ts (if (suffix === "/ws/import" && request.method === "GET") {), Commands you will need, Current state (+13 more)

### Community 225 - "Community 225"
Cohesion: 0.09
Nodes (22): code:block1 (# ─── Code Container (merged sim + editor) ─────────────────), code:block2 (# HALSIM_PORT_RANGE=34000-34099      # Loopback port range f), code:block3 (# MAX_ACTIVE_CONTAINERS=10           # Max simultaneously-ru), code:block4 (# METRICS_TOKEN=                     # Bearer token for scra), code:block5 (# CODERUNNER_DEMO_MODE=false         # Single-admin demo mod), Commands you will need, Current state, Done criteria (+14 more)
...
Cohesion: 0.09
Nodes (20): code:ts (test("X-Content-Type-Options nosniff is present on text/* re), code:ts (function applySecurityHeaders(response: Response): Response ), code:ts (test("X-Content-Type-Options nosniff is set on responses", a), Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes (+12 more)

### Community 236 - "Community 236"
Cohesion: 0.09
Nodes (21): `apps/control/src/halsim.ts`, `apps/control/src/nt4-auto.ts`, code:ts (export type BridgeEntryBase<W> = {), Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes (+13 more)
...
Cohesion: 0.09
Nodes (22): coderunner-lessons Example Repo, Publishing via LESSONS_CATALOG_REPO, Pushing Code to GitHub, Lesson Switch Discards Workspace, Work Discarded on Lesson Switch, LESSONS_CATALOG_REPO (FAQ mention), Switch Project Surface, Team Import Git Push Capability (+14 more)

### Community 241 - "Community 241"
Cohesion: 0.11
Nodes (22): AdvantageScope Lite Telemetry Flow, Control Plane (Bun/TypeScript), HALSim WebSocket, Network Mode, NetworkTables (NT4), Port Mode, Run Pipeline (Build + Simulate), Single Front Door (One HTTP/WS Port) (+14 more)

### Community 242 - "Community 242"
Cohesion: 0.14
Nodes (13): AppOptions, defaultRunCommandFactory, startFakeHalsim(), startFakeVscode(), AppFixture, FakeHalsimHandle, FakeVscodeHandle, SeededUser (+5 more)
...
Cohesion: 0.1
Nodes (19): Apache License v2.0, code:block1 (Version 3, 29 June 2007), code:block2 (Version 3.1, 31 March 2009), code:block3 (GNU GENERAL PUBLIC LICENSE), code:block4 (GNU LESSER GENERAL PUBLIC LICENSE), code:block5 (GNU LESSER GENERAL PUBLIC LICENSE), code:block6 (GNU Free Documentation License), code:block7 (/*-) (+11 more)
...
Cohesion: 0.1
Nodes (20): code:ts (export type AppSocket = {), code:ts (import { describe, expect, test } from "bun:test";), Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 008: Characterization tests for the WebSocket message router (+12 more)

### Community 258 - "Community 258"
Cohesion: 0.2
Nodes (21): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+13 more)
...
Cohesion: 0.12
Nodes (21): Lessons Catalog Variables, Bundled Lesson Catalog (/opt/frc-catalog), Writing Custom Lessons, Demo Mode (CODERUNNER_DEMO_MODE), Why the First Build/Run Is Slow, First Build/Run Warm-up Explanation, Primed Gradle/WPILib Dependency Cache, GitHub/Google OAuth Sign-in (+13 more)
...
Cohesion: 0.1
Nodes (16): code:ts (const inspectedByName = await inspectContainers(dockerRunner), Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 007: Batch `docker inspect` in `managedContainerStats`, Scope (+8 more)

### Community 280 - "Community 280"
Cohesion: 0.1
Nodes (17): code:ts (private async checkCapacity(): Promise<void> {), code:ts (// Restarting a stopped container consumes a capacity slot, ), Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 006: Apply capacity admission to container adoption (restart path) (+9 more)
...
Cohesion: 0.1
Nodes (19): authProvidersResponseSchema, autoChooserPatchSchema, autoChoosersResponseSchema, createFileRequestSchema, deployFilePathSchema, deployFilesSnapshotResponseSchema, gamepadClientMessageSchema, gamepadServerMessageSchema (+11 more)

### Community 284 - "Community 284"
Cohesion: 0.11
Nodes (20): Example Curriculum Progression, Non-Destructive Headless Gradle Override, plain-java Lesson Kind, robot Lesson Kind, launch.json Run Configuration, modules.json Manifest, Module Fields (id/title/subdir/kind/order), README.md as Lesson Text (+12 more)
...
Cohesion: 0.15
Nodes (18): About demo mode, code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (CODERUNNER_DOCKER_GID=$(stat -c '%g' /var/run/docker.sock) C), code:bash (CODERUNNER_DEMO_MODE=1 docker compose up), code:powershell ($env:CODERUNNER_DEMO_MODE = "1"; docker compose up), code:bat (set "CODERUNNER_DEMO_MODE=1" && docker compose up), code:bash (docker compose down --remove-orphans), Deploy for a team (+10 more)
...
Cohesion: 0.16
Nodes (18): Bind mounts, Build, code:bash (bun run docker:build:workspace), code:block2 (frc-sim.managed=true), code:bash (docker run -d \), code:bash (docker run -d \), Environment variables, Example run (+10 more)

### Community 311 - "Community 311"
Cohesion: 0.13
Nodes (9): INITIAL_STATE, ProjectSwapKind, ProjectSwapState, ProjectSwapStatus, FakeSocket, Listener, { result }, useProjectSwap() (+1 more)
...
Cohesion: 0.14
Nodes (19): Cloudflare Offline Page, Cloud Hosting Cost Estimate, Caddy (Auto-TLS Reverse Proxy), Cost and Sizing, Data Disk (prevent_destroy), Google Cloud Deployment, docker compose Stack (control/caddy/alloy), c4-standard-4 GCE VM (+11 more)
...
Cohesion: 0.11
Nodes (16): code:ts (export type ImportManagerOptions = Record<string, never>;), Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 002: Remove the dead `ImportManagerOptions` parameter, Scope (+8 more)
...
Cohesion: 0.14
Nodes (18): Data Directory Layout, SQLite Database (app.db), Admin and Metrics Variables, CODERUNNER_DEMO_MODE, How Environment Is Loaded, Environment Variable Configuration, Idle Management, Logging Variables (+10 more)
...
Cohesion: 0.12
Nodes (16): Admin and Metrics, Auth and OAuth, code:bash (bun run start -- --demo), Configuration Reference, Demo mode and the `--demo` flag, Docker and Containers, Docker Compose deployment, .env.example vs config.ts — notes (+8 more)
...
Cohesion: 0.21
Nodes (14): DistDownload, downloadAndExtract(), run(), withScratch(), Artifact, artifacts, downloadUrl(), fetchAndExtract() (+6 more)

### Community 361 - "Community 361"
Cohesion: 0.12
Nodes (15): Build, code:json ("java.project.referencedLibraries": [), code:json ("java.project.referencedLibraries": {), code:block3 (npm install), Contribution, Create Java Projects, Export Jar, Manage Dependencies (+7 more)
...
Cohesion: 0.12
Nodes (5): AUTHORS File Information, code:block1 (PNG REFERENCE LIBRARY AUTHORS), libpng License, libpng v1.6.51, libpng v1.6.57
...
Cohesion: 0.12
Nodes (5): AUTHORS File Information, code:block1, Harfbuzz 11.2.0, Harfbuzz 12.3.2, Harfbuzz License
...
Cohesion: 0.12
Nodes (17): 15. Staged Implementation Plan, code:block20 (docker build -t frc-spike-openvscode .), code:block21 (bun run docker:build:workspace), code:block22 (# Build and start a Stage 1 container manually.), code:block23 (bun run typecheck), code:block24 (bun run build:web), code:block25 (bun run typecheck), code:block26 (# Idle teardown:) (+9 more)

### Community 370 - "Community 370"
Cohesion: 0.17
Nodes (17): 3. Starting the App, code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m) (+9 more)
...
Cohesion: 0.14
Nodes (10): Listener, bridge, enabledDisable, FakeWebSocket, flush, joystick, messages, msg (+2 more)
...
Cohesion: 0.12
Nodes (16): first, NUM_RUNS, parsed, slugArb, allianceStationSchema, bridgeConnectionSchema, containerStateSchema, driverStationPatchSchema (+8 more)
...
Cohesion: 0.12
Nodes (15): Can CodeRunner run offline or without internet?, Can I build or start simulation from the WPILib extension?, Can I write my own lessons?, Can students accidentally break each other's work?, Can students push code to GitHub?, Do students need accounts? What if I just want to try it?, FAQ, How much does cloud hosting cost? (+7 more)
...
Cohesion: 0.12
Nodes (4): code:block1, GIFLIB License, GIFLIB v5.2.2, GIFLIB v6.1.2
...
Cohesion: 0.13
Nodes (4): Apache 2.0 License, Apache Commons BCEL Notice, Apache Commons Byte Code Engineering Library (BCEL) Version 6.10.0, Apache Commons Byte Code Engineering Library (BCEL) Version 6.7.0
...
Cohesion: 0.15
Nodes (14): Building the image locally, code:bash (bun run docker:build:workspace), code:block2 (docker build -f containers/code/Dockerfile -t ghcr.io/mathew), code:bash (bun run docker:pull:workspace), code:bash (bun run docker:build:workspace), code:bash (bun run docker:rebuild-workspaces), code:bash (bun run docker:rebuild-workspaces -- --dry-run), Editor acceptance smoke (+6 more)
...
Cohesion: 0.13
Nodes (3): zlib License, zlib v1.3.1, zlib v1.3.2
...
Cohesion: 0.15
Nodes (15): Demo Mode Walkthrough, Deploy for a Team, CodeRunner (Project), Demo Mode, Documentation Site (Docusaurus), MIT License, Third-Party Software Notices, Verification Suite (bun run verify) (+7 more)

### Community 523 - "Community 523"
Cohesion: 0.14
Nodes (12): AppSocket, CloseCall, fakeDocker, FakeSocket, fakeUpstream, forwarded, hello, importWs (+4 more)
...
Cohesion: 0.24
Nodes (12): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+4 more)
...
Cohesion: 0.17
Nodes (13): CODERUNNER_ADMIN_EMAIL Admin Bootstrap, coderunner allowlist add, coderunner allowlist (Local), BETTER_AUTH_SECRET, BETTER_AUTH_URL, CODERUNNER_ADMIN_EMAIL (Local), CODERUNNER_DOCKER_GID (Local), Data Directory Ownership (+5 more)

### Community 570 - "Community 570"
Cohesion: 0.23
Nodes (13): AdvantageScope Line Graph Telemetry Panel, Demo Mode Warning Banner, Console Output Panel, Sim Controls / Driver Station Panel, VSCodium Editor Pane, Explorer Sidebar (Java/Gradle project tree), AdvantageScope / PathPlanner Tab Switcher, RobotContainer.java Source (AdvantageKit Logger example) (+5 more)

### Community 571 - "Community 571"
Cohesion: 0.22
Nodes (13): docs/using-coderunner.md, docs/using-pathplanner.md, Auto Command Sequence Editor (Sequential/Deadline Groups), Console Output Panel, VSCodium Editor Pane (RobotContainer.java), PathPlanner Field/Path Preview (BlizzardKillOutpost), NamedCommands.registerCommand calls, Project File Explorer (pathplanner/autos, pathplanner/paths) (+5 more)
...
Cohesion: 0.17
Nodes (11): AdvantageScope, Components under copyleft licenses, Extension artifact sourcing, Known sourcing issue, Modifications, openvscode-server and Code – OSS, PathPlanner, Summary (+3 more)
...
Cohesion: 0.17
Nodes (11): Base image: `gitpod/openvscode-server:1.105.1`, Consequences, Context, Decision, Decision 012: V2 Code Image — Base Image and Extension Strategy, Direct launch base path handling, Extension cache seeding pattern, Extensions: download at build time (+3 more)
...
Cohesion: 0.17
Nodes (12): deploy-cloudflare Job, CF_ACCOUNT_ID / CF_API_TOKEN, Docker Compose Deployment Variables, Deploy Workflow (deploy.yml), Multi-Arch Images (amd64+arm64), coderunner rebuild-workspaces, Release Workflow (release.yml), Rollback via Redeploy (+4 more)
...
Cohesion: 0.18
Nodes (11): code:bash (# Seed Gradle cache on first run.), code:bash (# Fix ownership for /config and /workspace (linuxserver conv), code:bash (# Fix ownership of what this script created as root. The bas), code:bash (git add containers/code/root/etc/s6-overlay/s6-rc.d/init-frc), code:bash (git add <the test file>), code:bash (bun run docs:build && grep -rl "vscodium-web-migration" webs), code:bash (git add docs/decisions/036-vscodium-web-migration.md docs/de), File Structure (+3 more)
...
Cohesion: 0.18
Nodes (10): A classroom / LAN machine, A Google Cloud VM (Terraform-automated), Choose a deployment route, Cloudflare Offline Page (advanced, optional), Deployment Overview, Google Cloud Deployment (advanced), Local Deployment (recommended), Optional: Cloudflare offline page (+2 more)
...
Cohesion: 0.18
Nodes (10): Auto chooser, Controller and keyboard input, Live telemetry, Loading a project, Robot modes, Signing in, Starting and stopping a run, The Driver Station (+2 more)
...
Cohesion: 0.2
Nodes (9): Broad Docker smoke tier — not implemented, Consequences, Context, Decision, Decision 022: Skip Docker smoke tier and import/backup-restore E2E tests, Docker smoke tier — not implemented, Import and backup/restore tests — deferred, Import and backup/restore tests — updated after lessons rework (+1 more)
...
Cohesion: 0.2
Nodes (9): Architecture at runtime, code:block1 (internet ──443──> Caddy (VM) ──:4000──> bun control plane (s), CodeRunner GCE Deployment, Cost notes, deploy/, Sizing reference, Subdirectories, Verification (+1 more)
...
Cohesion: 0.24
Nodes (10): CodeRunner, Isolated Per-Student Workspace, Lessons and Team Projects, Lessons and Team Projects, Live Telemetry via AdvantageScope, One-Click Simulation & Driver Station, Self-Hosted, Modest to Run, Self-Hosted and Modest to Run (+2 more)
...
Cohesion: 0.33
Nodes (9): Console Output Panel, Enable/Disable Toggle, HALWebSim Websocket Connected Log, Mode Selector (Teleop/Auto/Test), NT4 Connection Log Entries (AdvantageScopeLite client), Using CodeRunner - Ready State Screenshot, Sim Controls Panel (Start/Stop/Restart), Status Indicators (Comms/Robot Code/Joysticks) (+1 more)

### Community 673 - "Community 673"
Cohesion: 0.22
Nodes (9): PathPlanner File API, Where PathPlanner Saves Changes, Don't Use WPILib Extension's Sim Command, PathPlanner Does Not Load / Misses Edits, Console Lessons, Driver Station, PathPlanner Tab, Use CodeRunner's Start Button, Not the WPILib Extension (+1 more)
...
Cohesion: 0.29
Nodes (5): [command, kind], dockerfiles, image, Kind, subprocess
...
Cohesion: 0.29
Nodes (7): 16. Manual End-to-End Test Plan, code:block28 (git clone <repo-url> CodeRunner), code:block29 (bun run docker:build:workspace), code:block30 (bun run migrate), code:block31 (# In another shell:), code:block32 (curl -fsS -X POST http://localhost:4000/admin/workspaces/<al), code:block33 (curl -fsS -X POST http://localhost:4000/admin/workspaces/<al)

### Community 737 - "Community 737"
Cohesion: 0.29
Nodes (7): Cloudflare Pages mode, code:block13 (student browser ──443──> Cloudflare Pages (coderunner)), code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.5.0), How it works, Ongoing releases, Rollback, Rollback
...
Cohesion: 0.29
Nodes (7): 16. Manual End-to-End Test Plan, code:block28 (git clone <repo-url> FRC-Programming-Training-Sim), code:block29 (bun run docker:build:workspace), code:block30 (bun run migrate), code:block31 (# In another shell:), code:block32 (curl -fsS -X POST http://localhost:4000/admin/workspaces/<al), code:block33 (curl -fsS -X POST http://localhost:4000/admin/workspaces/<al)

### Community 740 - "Community 740"
Cohesion: 0.38
Nodes (7): Connection Indicators (Comms/Robot Code/Joysticks), Console Output Panel (Run Channel Connected), Enable/Disabled Toggle, Mode Selector (Teleop/Auto/Test), Using CodeRunner: Start Screenshot, Sim Controls Panel (Start/Stop/Restart), VSCodium Editor Status Bar
...
Cohesion: 0.33
Nodes (5): Console lessons, Explore more, Get started, Robot lessons and imported projects, Using CodeRunner
...
Cohesion: 0.53
Nodes (5): 039 — PathPlanner integration, 039 — PathPlanner integration (deploy-files API + dormant UI), Consequences, Context, Decision
...
Cohesion: 0.4
Nodes (6): 11. Lessons and Project Import, 11. Project Import, Endpoints, Lessons catalog, Limits, Team GitHub import (build season)
...
Cohesion: 0.4
Nodes (6): GradleRIO 2026.2.1 / Temurin 17.0.15, wpilibsuite.vscode-wpilib 2026.1.1, vscode-wpilib Extension Activation (log), Local GradleRIO Version 2026.2.1 (log), Bad Java Version Fallback to JDK 17 (log), JDT LS Java Home Version 21 (log)
...
Cohesion: 0.4
Nodes (4): Dependency notes, Execution order & status, Findings considered and rejected (so they are not re-audited), Implementation Plans
...
Cohesion: 0.4
Nodes (4): Bonus, code:java (FrcTeam team1 = new FrcTeam(5885, new int[] {70, 75, 80});), Score Predictor, Steps
...
Cohesion: 0.4
Nodes (4): Active (V2 and post-V2), Archive, Decision Logs, V1 Decision Logs
...
Cohesion: 0.5
Nodes (3): Bonus, Kitbot Controls, Steps

### Community 1094 - "Community 1094"
Cohesion: 0.5
Nodes (3): Bonus, Number Guessing Game, Steps

### Community 1095 - "Community 1095"
Cohesion: 0.5
Nodes (3): Bonus, Perimeter and Area, Steps

### Community 1096 - "Community 1096"
Cohesion: 0.5
Nodes (3): Bonus, PID Controllers, Steps

### Community 1097 - "Community 1097"
Cohesion: 0.5
Nodes (3): Bonus, Closest Distance, Steps

### Community 1098 - "Community 1098"
Cohesion: 0.5
Nodes (3): Bonus, Command-Based Robot, Steps

### Community 1099 - "Community 1099"
Cohesion: 0.5
Nodes (3): Bonus, Steps, Timed Robot

### Community 1100 - "Community 1100"
Cohesion: 0.5
Nodes (3): Bonus, Perimeter and Area Part 2, Steps
...
Cohesion: 0.5
Nodes (4): ASSETS Binding, BACKEND_ORIGIN Secret, origin.YOUR_DOMAIN Caddy Vhost, Pages Function Catch-all
...
Cohesion: 0.67
Nodes (3): Program Error: Could not find or load main class x, Reason:, Try:

### Community 1223 - "Community 1223"
Cohesion: 0.67
Nodes (3): Please specify the host name and the port of the remote debuggee in the launch.json., Reason:, Try:

### Community 1224 - "Community 1224"
Cohesion: 0.67
Nodes (3): Failed to complete hot code replace:, Reason:, Try:

### Community 1225 - "Community 1225"
Cohesion: 0.67
Nodes (3): Failed to evaluate. Reason: Cannot evaluate because the thread is resumed., Reason:, Try:

### Community 1226 - "Community 1226"
Cohesion: 0.67
Nodes (3): Reason:, Try:, x.java isn't on the classpath. Only syntax errors will be reported

### Community 1227 - "Community 1227"
Cohesion: 0.67
Nodes (3): Program throws UnsupportedClassVersionError, Reason:, Try:

### Community 1228 - "Community 1228"
Cohesion: 0.67
Nodes (3): Reason:, Request type "xyz" is not supported. Only "launch" and "attach" are supported., Try:

### Community 1229 - "Community 1229"
Cohesion: 0.67
Nodes (3): Cannot find a class with the main method, Reason:, Try:

### Community 1230 - "Community 1230"
Cohesion: 0.67
Nodes (3): Failed to resolve classpath:, Reason:, Try:

### Community 1231 - "Community 1231"
Cohesion: 0.67
Nodes (3): Build failed, do you want to continue?, Reason:, Try:

### Community 1232 - "Community 1232"
Cohesion: 0.67
Nodes (3): No delegateCommandHandler for vscode.java.startDebugSession when starting Debugger, Reason:, Try:

### Community 1233 - "Community 1233"
Cohesion: 0.67
Nodes (3): Program throws ClassNotFoundException, Reason:, Try:
...
Cohesion: 0.67
Nodes (3): Custom Domain Setup, Cloudflare Pages Project, Wrangler CLI

## Ambiguous Edges - Review These
- `Demo Mode Warning Banner` → `Switch Project Button`  [AMBIGUOUS]
  website/static/img/screenshots/demo-mode-landing.png · relation: conceptually_related_to

## Knowledge Gaps
- **6921 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6916 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **736 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **What is the exact relationship between `Demo Mode Warning Banner` and `Switch Project Button`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Robot` connect `Community 55` to `WPILib Robot Examples (vendored)`, `Community 165`, `Community 38`, `Community 282`, `Community 186`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 38` to `Community 24`, `Community 26`, `Community 22`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 94` to `Community 282`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _6921 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `WPILib Robot Examples (vendored)` be split into smaller, more focused modules?**
  _Cohesion score 0.0 - nodes in this community are weakly interconnected._
- **Should `WPILib C++ Robot Mains (vendored)` be split into smaller, more focused modules?**
