...
## Corpus Check
- 997 files · ~720,012 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25838 nodes · 48766 edges · 2641 communities (1850 shown, 791 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `439c76d9`
...
## Communities (2641 total, 791 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (7): main(), Robot(), shootTrigger(), Robot, Robot, Robot, TimedRobot

### Community 1 - "Community 1"
Cohesion: 0.0
Nodes (7): Command, DriveDistance, DriveTime, TurnDegrees, TurnTime, m_autoTime(), SysIdRoutineBot
...
Cohesion: 0.01
Nodes (223): AppSocket, createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions (+215 more)
...
Cohesion: 0.02
Nodes (10): Main, Main, Main, Main, Main, Main, RobotBase, EducationalRobot (+2 more)
...
Cohesion: 0.02
Nodes (115): getDemoSessionResponseBody(), seedDemoUser(), input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside() (+107 more)
...
Cohesion: 0.04
Nodes (70): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+62 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (75): sendUpstreamWebSocketMessage(), log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls, cloneCall (+67 more)
...
Cohesion: 0.03
Nodes (88): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+80 more)
...
Cohesion: 0.02
Nodes (5): Robot, Robot, Robot, Robot, Robot
...
Cohesion: 0.05
Nodes (6): DoubleSupplier, KickerIOSpark, RollerIOSpark, SpindexerIOSpark, Drive, SparkUtil

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (6): PreSpinFlywheelCommand, SysIDCommands, FlywheelIO, HoodIO, ShooterSubsystem, AimHoodAndSpinFlywheelCommand
...
Cohesion: 0.05
Nodes (47): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+39 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (44): BINDING_GROUPS, bp(), Bumper(), bv(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+36 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (5): StopDrivingCommand, AssistedDriveCommand, DriveCommands, WheelRadiusCharacterizationState, DriveToPoseCommand
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.3.1 - 2017-11-17 (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.30.0, 0.30.1, 0.31.0, 0.31.3 (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.1, 0.35.1 (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.4, 0.24.1, 0.30.0, 0.31.0, 0.31.1, 0.31.3 (+39 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.31.3 (+39 more)
...
Cohesion: 0.08
Nodes (25): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail() (+17 more)
...
Cohesion: 0.05
Nodes (5): ax(), FlywheelIOSim, HoodIOSim, clamp(), TurretIOSim
...
Cohesion: 0.14
Nodes (35): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+27 more)
...
Cohesion: 0.08
Nodes (4): ControllerUtil, getPose(), OverrideUtil, ShootingLocation()
...
Cohesion: 0.06
Nodes (23): 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.11
Nodes (19): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+11 more)
...
Cohesion: 0.07
Nodes (29): 0.10.2, 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.10.2, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 148 - "Community 148"
Cohesion: 0.07
Nodes (27): 0.10.1, 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.11
Nodes (29): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration (+21 more)
...
Cohesion: 0.07
Nodes (27): 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.08
Nodes (6): ModuleIO, TurretIO, VisionIOPhotonVision, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.12
Nodes (16): seedRuntimeMissing(), seedRuntimeRunning(), seedWorkspaceProject(), cookie, snapshot, status, wsp, console (+8 more)
...
Cohesion: 0.12
Nodes (20): Bundled Lesson Catalog (/opt/frc-catalog), Authoring Custom Lessons / LESSONS_CATALOG_REPO, Demo Mode (CODERUNNER_DEMO_MODE), First Build/Run Slowness, First Build/Run Warm-up Explanation, Primed Gradle/WPILib Dependency Cache, GitHub/Google OAuth Sign-in, Offline Operation Capability (+12 more)
...
Cohesion: 0.2
Nodes (19): 7. Cache Cleanup, Admin status API, code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+11 more)
...
Cohesion: 0.14
Nodes (14): coderunner-lessons Example Repo, Publishing via LESSONS_CATALOG_REPO, LESSONS_CATALOG_REPO (FAQ mention), Bundled Catalog Source, 60-Second Catalog Cache, Remote Catalog Source, Switch Project Menu (Lessons + Team Import), build.gradle Verification (+6 more)
...
Cohesion: 0.19
Nodes (4): FakeSocket, { rerender }, { result }, { unmount }
...
Cohesion: 0.31
Nodes (11): code:bash (CODE_MEMORY_LIMIT=3072m), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), Configuration (+3 more)
...
Cohesion: 0.25
Nodes (8): Student GitHub Push (Team Import), Lesson Switch Discards Workspace, Switch Project Surface, Team Import Git Push Capability, Per-Student Workspace Isolation, Switching Modules Discards Workspace, Lessons Are Gitless, Switching Away Discards Import Workspace
...
Cohesion: 0.5
Nodes (3): console_, freshConsole, separator
...
## Knowledge Gaps
- **6881 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6876 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **791 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 61` to `Community 0`, `Community 834`, `Community 711`, `Community 299`, `Community 495`, `Community 86`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 91` to `Community 299`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 86` to `Community 19`, `Community 22`, `Community 23`?**
