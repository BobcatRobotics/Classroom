# Graph Report - CodeRunner  (2026-08-31)

## Corpus Check
- 1084 files · ~745,289 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25650 nodes · 48637 edges · 2554 communities (1823 shown, 731 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 446 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6690683b`
...
## Communities (2554 total, 731 thin omitted)
...
Cohesion: 0.0
Nodes (11): Command, DriveDistance, DriveLeftCommand, DriveToPoseCommand, ExampleCommand, TurnTime, m_autoTime(), RetractIntakeCommand (+3 more)
...
Cohesion: 0.01
Nodes (205): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), DockerCommandResult (+197 more)
...
Cohesion: 0.03
Nodes (79): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange (+71 more)
...
Cohesion: 0.05
Nodes (39): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+31 more)
...
Cohesion: 0.04
Nodes (39): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.3.1 - 2017-11-17, 0.40.0 - 2022-03-28 (+31 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.34.0 - 2021-05-26 (+33 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1 (+41 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (39): 0.15.1 - 2019-03-19, 0.22.4, 0.30.0, 0.30.1, 0.31.0, 0.31.1, 0.31.3, 0.35.2 (+31 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.30.1, 0.31.0 (+39 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.1 (+39 more)
...
Cohesion: 0.08
Nodes (3): DoubleSupplier, Drive, SparkUtil
...
Cohesion: 0.06
Nodes (31): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar(), TopbarProps, Avatar() (+23 more)
...
Cohesion: 0.07
Nodes (12): 01 - Hello, World, Bonus, Hello, Name, Intentional Template Contents, Kitbot Controls, Provenance, Robot Starter, Running it (+4 more)
...
Cohesion: 0.07
Nodes (29): 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.19.1, 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)
...
Cohesion: 0.07
Nodes (24): 0.18.7, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.17
Nodes (27): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+19 more)
...
Cohesion: 0.13
Nodes (25): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup (+17 more)
...
Cohesion: 0.13
Nodes (16): bp(), bv(), GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad, { result } (+8 more)
...
Cohesion: 0.23
Nodes (18): code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries) (+10 more)
...
Cohesion: 0.31
Nodes (9): 6. Backup and Restore, code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir> --dry-run                   ), Create a backup, Recommended backup schedule, Restore from backup (+1 more)
...
## Knowledge Gaps
- **6751 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6746 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **731 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 52` to `Community 0`, `Community 773`, `Community 84`, `Community 149`, `Community 278`, `Community 473`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 84` to `Community 26`, `Community 19`, `Community 23`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 89` to `Community 278`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _6751 weakly-connected nodes found - possible documentation gaps or missing edges._
