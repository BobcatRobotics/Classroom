...
## Corpus Check
- 2518 files · ~2,095,680 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21569 nodes · 41359 edges · 2094 communities (1472 shown, 622 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `edba345b`
...
## Communities (2094 total, 622 thin omitted)
...
Cohesion: 0.01
Nodes (10): Command, DriveDistance, DriveToPoseCommand, OuttakeCommand, TurnTime, m_autoTime(), RapidReactCommandBot, ShootIfReadyCommand (+2 more)
...
Cohesion: 0.01
Nodes (8): ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), log(), SubsystemBase(), XRPDrivetrain
...
Cohesion: 0.02
Nodes (21): DoubleSupplier, DriveIOSpark, ModuleIOSpark, SparkOdometryThread, ExtensionIOSpark, FlywheelIOSpark, HoodIOSpark, KickerIOSpark (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (176): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+168 more)
...
Cohesion: 0.03
Nodes (91): getDemoSessionResponseBody(), seedDemoUser(), input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside() (+83 more)
...
Cohesion: 0.03
Nodes (63): AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, LessonLoadSocketData, Nt4SocketData (+55 more)
...
Cohesion: 0.05
Nodes (45): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+37 more)

### Community 25 - "Community 25"
Cohesion: 0.04
Nodes (53): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+45 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (75): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+67 more)
...
Cohesion: 0.05
Nodes (61): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+53 more)
...
Cohesion: 0.07
Nodes (18): EMPTY, Autonomous(), Disabled(), EndCompetition(), StartCompetition(), Teleop(), Test(), Args (+10 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (42): BINDING_GROUPS, bp(), Bumper(), bv(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+34 more)
...
Cohesion: 0.04
Nodes (41): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.31.1, 0.33.1, 0.35.1 (+33 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.31.0, 0.31.1, 0.31.3 (+39 more)
...
Cohesion: 0.11
Nodes (5): ContainerOrchestrator, dockerError(), dockerPortBindError(), publishedPortFor(), simContainerName()
...
Cohesion: 0.1
Nodes (26): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor() (+18 more)
...
Cohesion: 0.07
Nodes (28): 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)
...
Cohesion: 0.15
Nodes (30): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token) (+22 more)
...
## Knowledge Gaps
- **4883 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+4878 more)
...
- **Why does `Robot` connect `Community 54` to `Community 0`, `Community 130`, `Community 38`, `Community 458`, `Community 142`, `Community 279`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 35` to `Community 26`, `Community 19`, `Community 22`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 88` to `Community 279`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _4883 weakly-connected nodes found - possible documentation gaps or missing edges._
