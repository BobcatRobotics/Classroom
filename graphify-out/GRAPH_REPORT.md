...
## Corpus Check
- 1020 files · ~774,604 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22795 nodes · 44103 edges · 2199 communities (1577 shown, 622 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7ef12b9`
...
## Communities (2199 total, 622 thin omitted)
...
Cohesion: 0.0
Nodes (10): Command, ReplaceMeCommand, DriveDistance, DriveToPoseCommand, TurnDegrees, RobotContainer, m_autoTime(), RapidReactCommandBot (+2 more)
...
Cohesion: 0.01
Nodes (11): Periodic(), ReplaceMeSubsystem2(), ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), RomiDrivetrain (+3 more)
...
Cohesion: 0.01
Nodes (204): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+196 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (14): RobotContainer, ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand, InstantCommand (+6 more)
...
Cohesion: 0.02
Nodes (14): DoubleSupplier, DriveIOSpark, ModuleIOSpark, FlywheelIOSpark, HoodIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand (+6 more)
...
Cohesion: 0.04
Nodes (64): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+56 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (95): handleUploadAsset(), userAssetsPath(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), input, stripped, apiError() (+87 more)
...
Cohesion: 0.04
Nodes (69): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, envContainerUser() (+61 more)
...
Cohesion: 0.03
Nodes (9): IndexerIOSim, IndexerIO, ModuleIO, TurretIOTalonFX, TurretIO, VisionIOPhotonVision, VisionIOPhotonVisionSim, VisionIO (+1 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (44): EditorPane(), EditorPaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar(), TopbarProps, MODE_CLASSES (+36 more)
...
Cohesion: 0.04
Nodes (9): DriveIOSim, DriveIOTalonFX, DriveIOTalonSRX, DriveIO, GyroIO, SuperstructureIOSim, SuperstructureIOTalonFX, SuperstructureIOTalonSRX (+1 more)
...
Cohesion: 0.04
Nodes (20): AdminApp(), ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState (+12 more)
...
Cohesion: 0.05
Nodes (32): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+24 more)
...
Cohesion: 0.08
Nodes (32): AdminLayout(), Tab, tabs, RunControls(), RunControlsProps, useAdminPoll(), Allowlist(), AllowlistData (+24 more)
...
Cohesion: 0.05
Nodes (35): DemoBanner(), ScopePane, ScopePaneProps, patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers() (+27 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.27.1 - 2020-07-21, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17 (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.05
Nodes (32): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+24 more)
...
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.24.1, 0.30.0, 0.33.1, 0.35.1, 0.35.2, 0.37.1 (+31 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (47): 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.1, 0.31.3, 0.35.1 (+39 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (6): ModuleIOTalonFX, IndexerIOTalonFX, IntakeIOSim, IntakeIOTalonFX, IntakeIOTalonFXDual, IntakeIO

### Community 63 - "Community 63"
Cohesion: 0.09
Nodes (30): containerName(), ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), DockerCommandResult, dockerError(), DockerInspectContainer, isLoopbackHost() (+22 more)
...
Cohesion: 0.1
Nodes (4): ContainerOrchestrator, dockerPortBindError(), portIsFree(), Semaphore
...
Cohesion: 0.06
Nodes (4): GyroIOPigeon2, PhoenixOdometryThread, PhoenixUtil, VirtualPD
...
Cohesion: 0.15
Nodes (32): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+24 more)
...
Cohesion: 0.07
Nodes (29): 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.1.0 - 2018-10-19, 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 134 - "Community 134"
Cohesion: 0.07
Nodes (27): 0.18.7, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.19
Nodes (14): 6. Backup and Restore, code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir>), code:bash (bun run restore -- <backup-dir> --dry-run                   ) (+6 more)
...
- **622 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 68` to `Community 608`, `Community 33`, `Community 0`, `Community 101`, `Community 714`, `Community 46`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 33` to `Community 20`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 93` to `Community 46`?**
