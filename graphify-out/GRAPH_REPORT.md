# Graph Report - CodeRunner  (2026-09-02)

## Corpus Check
- 1101 files · ~766,189 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25969 nodes · 49027 edges · 2604 communities (1862 shown, 742 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 467 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c1eed3b`
...
- `GradleRIO 2026.2.1 / Temurin 17.0.15` --semantically_similar_to--> `Bad Java Version Fallback to JDK 17 (log)`  [INFERRED] [semantically similar]
  docs/reference/faq.md → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/wpilib/2026/logs/wpilibtoollog.txt
...
## Communities (2604 total, 742 thin omitted)
...
Cohesion: 0.01
Nodes (5): Command, ArcadeDrive, DriveToPoseCommand, m_autoTime(), SysIdRoutineBot
...
Cohesion: 0.01
Nodes (213): createWebSocketHandlers(), seedDemoUser(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions (+205 more)
...
Cohesion: 0.02
Nodes (14): DoubleSupplier, DriveIOSpark, ModuleIOSpark, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand (+6 more)
...
Cohesion: 0.02
Nodes (10): ShootUntilHopperEmptyCommand, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, ParallelDeadlineGroup, ReplaceMeParallelDeadlineGroup (+2 more)
...
Cohesion: 0.02
Nodes (10): Main, Main, Main, Main, Main, Main, RobotBase, Main (+2 more)
...
Cohesion: 0.04
Nodes (37): codeContainerName(), CodeContainerStatus, containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), dockerError() (+29 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (70): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints(), defaultDockerRunner(), dockerError(), dockerPortBindError() (+62 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (100): handleUploadAsset(), userAssetsPath(), getDemoSession(), getDemoSessionResponseBody(), getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), log (+92 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (74): sendUpstreamWebSocketMessage(), log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls, cloneCall (+66 more)
...
Cohesion: 0.05
Nodes (87): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+79 more)
...
Cohesion: 0.04
Nodes (45): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+37 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (76): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange (+68 more)
...
Cohesion: 0.03
Nodes (4): AssistedDriveCommand, round, ChassisTrapezoidalController, GeometryUtil
...
Cohesion: 0.05
Nodes (47): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+39 more)
...
Cohesion: 0.05
Nodes (34): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+26 more)

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (36): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+28 more)
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.3.1 - 2017-11-17, 0.40.0 - 2022-03-28 (+31 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1 (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.1, 0.31.1 (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.27.0, 0.31.0, 0.31.3, 0.33.1 (+39 more)
...
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.3 (+39 more)
...
Cohesion: 0.06
Nodes (4): DriveIO, GyroIO, RobotContainer, SuperstructureIO
...
Cohesion: 0.07
Nodes (3): DriveSubsystem, VisionConsumer, VisionSubsystem
...
Cohesion: 0.08
Nodes (30): PANEL_IDS, SimPanePanels(), SimPanePanelsProps, SimPaneSwitcher(), SimPaneSwitcherProps, SimPaneTab, SimPaneTabs(), SimPaneTabSelector() (+22 more)
...
Cohesion: 0.07
Nodes (25): AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, LessonLoadSocketData, Nt4SocketData (+17 more)
...
Cohesion: 0.15
Nodes (33): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+25 more)
...
Cohesion: 0.06
Nodes (8): ModuleIOTalonFX, IndexerIOSim, IndexerIO, ModuleIO, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision

### Community 139 - "Community 139"
Cohesion: 0.08
Nodes (4): IntakeIOSim, IntakeIOTalonFX, IntakeIOTalonFXDual, IntakeIO
...
Cohesion: 0.07
Nodes (29): 0.18.9, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.10.2, 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 150 - "Community 150"
Cohesion: 0.07
Nodes (27): 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.07
Nodes (27): 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.10.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.13
Nodes (26): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, Between class sessions (+18 more)
...
Cohesion: 0.11
Nodes (25): Build times out, code:bash (# Confirm Docker is running), code:bash (SIM_PORT_RANGE=25810-25999), code:bash (# 1. Prune run logs (safest, often largest single contributo), code:bash (bun run backup), code:bash (docker compose restart control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (stat -c '%g' /var/run/docker.sock     # e.g. 999) (+17 more)
...
Cohesion: 0.17
Nodes (22): 7. Cache Cleanup, 8. Monitoring, Admin status API, code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*) (+14 more)

### Community 234 - "Community 234"
Cohesion: 0.12
Nodes (22): 5. Configuration, 6. Backup and Restore, code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup) (+14 more)
...
Cohesion: 0.14
Nodes (14): bp(), GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad, { result }, UseGamepadResult (+6 more)
...
Cohesion: 0.16
Nodes (12): seedRuntimeMissing(), seedRuntimeRunning(), seedWorkspaceProject(), snapshot, status, wsp, body, projectPath (+4 more)
...
Cohesion: 0.15
Nodes (14): Example Curriculum Progression, Non-Destructive Headless Gradle Override, plain-java Lesson Kind, robot Lesson Kind, launch.json Run Configuration, modules.json Manifest, Module Fields (id/title/subdir/kind/order), README.md as Lesson Text (+6 more)
...
Cohesion: 0.28
Nodes (13): code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)) (+5 more)
...
Cohesion: 0.15
Nodes (13): First Build/Run Slowness, First Build/Run Warm-up Explanation, Primed Gradle/WPILib Dependency Cache, wpilibsuite.vscode-wpilib 2026.1.1, GradleRIO 2026.2.1 / Temurin 17.0.15, docker:build:workspace / scripts/image.ts, VSCodium reh-web (codium-server), container_leases DB Table Reset (+5 more)
...
Cohesion: 0.2
Nodes (12): Bundled Lesson Catalog (/opt/frc-catalog), Authoring Custom Lessons / LESSONS_CATALOG_REPO, Demo Mode (CODERUNNER_DEMO_MODE), Student GitHub Push (Team Import), Lesson Switch Discards Workspace, GitHub/Google OAuth Sign-in, Offline Operation Capability, Offline / No-Internet Operation (+4 more)
...
Cohesion: 0.18
Nodes (10): AdvantageScope, Components under copyleft licenses, Extension artifact sourcing, Known sourcing issue, Modifications, openvscode-server and Code – OSS, Summary, Third-Party Notices (+2 more)
...
Cohesion: 0.2
Nodes (9): Architecture, code:text (Browser (one student)), code:text (data/), How a Run works, How telemetry flows, Persistence and data layout, The single front door, What the control plane does (+1 more)
...
Cohesion: 0.31
Nodes (8): Artifact, artifacts, downloadUrl(), fetchAndExtract(), main(), repoRoot, run(), tagArgIndex
...
Cohesion: 0.33
Nodes (6): Red Hat Java / Java Test Duplicate ASM Bundles, Editor Acceptance Smoke (e2e:workspace-java), WPILib Vendor Dependencies Activity Smoke Case, ./gradlew build Invocations (log), WPILib Java Simulate Launch Config (log), simulateExternalJavaRelease Gradle Task (log)
...
Cohesion: 0.4
Nodes (4): 039 — PathPlanner integration (deploy-files API + dormant UI), Consequences, Context, Decision
...
## Knowledge Gaps
- **6900 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6895 more)
...
- **Why does `Robot` connect `Community 55` to `Community 0`, `Community 835`, `Community 836`, `Community 38`, `Community 251`, `Community 61`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 38` to `Community 24`, `Community 26`, `Community 115`, `Community 23`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 91` to `Community 61`?**
