...
## Corpus Check
- 2517 files · ~2,093,579 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21548 nodes · 41322 edges · 2111 communities (1483 shown, 628 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b7c411f`
...
## Communities (2111 total, 628 thin omitted)
...
Cohesion: 0.01
Nodes (11): StopDrivingCommand, Command, ReplaceMeCommand, DriveDistance, DriveTime, DriveToPoseCommand, TurnTime, m_autoTime() (+3 more)
...
Cohesion: 0.02
Nodes (169): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), DockerRunner (+161 more)
...
Cohesion: 0.03
Nodes (85): log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls, cloneCall, ctx (+77 more)
...
Cohesion: 0.03
Nodes (101): handleUploadAsset(), userAssetsPath(), createWebSocketHandlers(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), After, Before (+93 more)
...
Cohesion: 0.03
Nodes (85): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+77 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (89): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+81 more)
...
Cohesion: 0.05
Nodes (46): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail(), IconRailButton() (+38 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (39): GamepadLease, GamepadSessions, halsimTarget(), BridgeEntry, DEFAULT_DRIVER_STATION, defaultSnapshot(), DriverStationState, HalSimBridge (+31 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (35): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+27 more)
...
Cohesion: 0.04
Nodes (41): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.30.1, 0.31.0, 0.35.1, 0.35.2 (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+33 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17 (+33 more)

### Community 49 - "Community 49"
Cohesion: 0.07
Nodes (4): DoubleSupplier, RollerIOSpark, Drive, SparkUtil

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (8): IdleManager, IdleManagerOptions, log, AppStorage, ensureWorkspaceFiles(), nowIso(), randomId(), slugFromDisplayName()

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)
...
Cohesion: 0.11
Nodes (5): ContainerOrchestrator, containerRuntimeState(), dockerError(), dockerPortBindError(), workspaceHomePath()
...
Cohesion: 0.07
Nodes (28): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, DriverStation(), MatchTimer(), MatchTimerProps, STATION_LABELS (+20 more)
...
Cohesion: 0.1
Nodes (28): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+20 more)

### Community 96 - "Community 96"
Cohesion: 0.1
Nodes (27): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor() (+19 more)
...
Cohesion: 0.07
Nodes (28): 0.10.1, 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)
...
Cohesion: 0.12
Nodes (27): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration (+19 more)
...
Cohesion: 0.08
Nodes (3): ModuleIOSpark, ModuleIOTalonFX, ModuleIO
...
Cohesion: 0.19
Nodes (4): FakeSocket, { result }, { unmount }, useRunChannel()
...
## Knowledge Gaps
- **4868 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+4863 more)
...
- **Why does `Robot` connect `Community 52` to `Community 0`, `Community 129`, `Community 34`, `Community 312`, `Community 314`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 88` to `Community 312`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 75` to `Community 19`, `Community 22`, `Community 15`?**
