...
## Corpus Check
- 1743 files · ~1,309,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24126 nodes · 46911 edges · 2344 communities (1704 shown, 640 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35d640eb`
...
## Communities (2344 total, 640 thin omitted)
...
Cohesion: 0.0
Nodes (8): Command, ArcadeDrive, DriveDistance, DriveTime, DriveToPoseCommand, m_autoTime(), RetractIntakeCommand, SysIdRoutineBot
...
Cohesion: 0.01
Nodes (216): AppSocket, createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions (+208 more)
...
Cohesion: 0.02
Nodes (13): DoubleSupplier, DriveIOSpark, ModuleIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, TurretCommands (+5 more)
...
Cohesion: 0.02
Nodes (121): getDemoSessionResponseBody(), seedDemoUser(), After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples, Rename (+113 more)
...
Cohesion: 0.03
Nodes (76): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+68 more)
...
Cohesion: 0.05
Nodes (83): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+75 more)
...
Cohesion: 0.04
Nodes (51): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+43 more)
...
Cohesion: 0.05
Nodes (7): ax(), FlywheelIOSim, FlywheelIO, HoodIOSim, HoodIO, clamp(), ShooterSubsystem
...
Cohesion: 0.06
Nodes (44): ConsolePane(), ConsolePaneProps, Avatar(), InitialsAvatar(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES (+36 more)
...
Cohesion: 0.05
Nodes (34): UserMenu(), BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton() (+26 more)
...
Cohesion: 0.04
Nodes (39): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.34.0 - 2021-05-26 (+31 more)
...
Cohesion: 0.04
Nodes (39): 0.15.1 - 2019-03-19, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.1, 0.35.1, 0.37.1 (+31 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+39 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.1, 0.31.0, 0.31.1 (+39 more)
...
Cohesion: 0.05
Nodes (3): GyroIONavX, SparkOdometryThread, TunableDouble
...
Cohesion: 0.08
Nodes (4): TunableControlConstants, TunableControls, TunablePIDController, TunableProfiledController
...
Cohesion: 0.07
Nodes (28): 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)

### Community 141 - "Community 141"
Cohesion: 0.07
Nodes (27): 0.23.1, 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.09
Nodes (7): IndexerIOSim, IndexerIO, ModuleIO, TurretIO, VisionIOPhotonVision, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.17
Nodes (15): code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m) (+7 more)
...
## Knowledge Gaps
- **5621 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5616 more)
...
- **Why does `Robot` connect `Community 51` to `Community 0`, `Community 44`, `Community 85`, `Community 342`, `Community 152`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 91` to `Community 342`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 85` to `Community 24`, `Community 17`, `Community 28`?**
