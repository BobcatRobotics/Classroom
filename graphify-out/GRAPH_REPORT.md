...
## Corpus Check
- 989 files · ~707,440 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25650 nodes · 48539 edges · 2564 communities (1835 shown, 729 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 451 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5fc110fa`
...
- `pad()` --calls--> `timestamp()`  [INFERRED]
  apps/control/src/logging.ts → scripts/backup.ts

## Hyperedges (group relationships)
- **Deployment Route Decision** — overview_deployment, local_deployment, gcloud_deployment, cloudflare_offline_page [INFERRED 0.85]
- **Admin/Allowlist Bootstrap Pattern** — local_coderunner_admin_email, gcloud_admin_bootstrap, local_allowlist_cli, gcloud_allowlist [INFERRED 0.85]
- **Release-to-Deploy Pipeline** — gcloud_release_workflow, gcloud_deploy_workflow, cloudflare_deploy_job, gcloud_multi_arch_images [INFERRED 0.85]

## Communities (2564 total, 729 thin omitted)
...
Cohesion: 0.0
Nodes (8): Command, DriveDistance, DriveTime, TurnTime, RobotContainer, m_autoTime(), RapidReactCommandBot, SysIdRoutineBot
...
Cohesion: 0.01
Nodes (221): AppSocket, cloneCall, copyCall, importer, mock, projectDir, samples, workspace (+213 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (10): SetBrakeModeCommand, m_autoDistance(), RobotContainer(), InstantCommand, ReplaceMeInstantCommand, RobotContainer, ParallelRaceGroup, ReplaceMeParallelRaceGroup (+2 more)
...
Cohesion: 0.02
Nodes (18): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer (+10 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (74): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+66 more)
...
Cohesion: 0.03
Nodes (90): getDemoSessionResponseBody(), seedDemoUser(), input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside() (+82 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (68): sendUpstreamWebSocketMessage(), createWebSocketHandlers(), log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls (+60 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (88): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+80 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (82): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+74 more)
...
Cohesion: 0.05
Nodes (38): activeWorkspaces, DockerStatsPoller, DockerStatsPollerOptions, log, containerCpuPercent, containerMemoryPercent, containerStartBuckets, httpBuckets (+30 more)
...
Cohesion: 0.06
Nodes (31): EMPTY, Indexer, applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles(), repoRoot (+23 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (44): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (42): BINDING_GROUPS, bp(), Bumper(), bv(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+34 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (37): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail() (+29 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (41): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+33 more)
...
Cohesion: 0.06
Nodes (33): DemoBanner(), patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers(), UseAutoChoosersReturn, { result } (+25 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (6): IntakeCommand, IntakeControlCommand, ControllerUtil, getPose(), OverrideUtil, ShootingLocation()

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (39): 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17, 0.40.0 - 2022-03-28 (+31 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (41): 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)
...
Cohesion: 0.04
Nodes (39): 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.31.3 (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)
...
Cohesion: 0.05
Nodes (47): Cloudflare Offline Page, Bundled Lesson Catalog, Cloud Hosting Cost Estimate, CODE_MEMORY_LIMIT, Authoring Custom Lessons / LESSONS_CATALOG_REPO, Demo Mode (FAQ), First Build/Run Slowness, Student GitHub Push (Team Import) (+39 more)
...
Cohesion: 0.05
Nodes (3): GyroIOPigeon2, PhoenixOdometryThread, TurretIOTalonFX

### Community 87 - "Community 87"
Cohesion: 0.1
Nodes (5): containerName(), ContainerOrchestrator, portIsFree(), Semaphore, simContainerName()
...
Cohesion: 0.08
Nodes (3): Intake, Intakes, IntakeVisualizer
...
Cohesion: 0.05
Nodes (3): DriveIOSpark, SuperstructureIOSpark, TurretIOSpark
...
Cohesion: 0.09
Nodes (27): CodeContainerStatus, ContainerOrchestratorOptions, defaultDockerRunner(), dockerError(), DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor() (+19 more)
...
Cohesion: 0.06
Nodes (4): ax(), FlywheelIOSim, clamp(), TurretIOSim
...
Cohesion: 0.1
Nodes (21): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+13 more)
...
Cohesion: 0.15
Nodes (32): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token) (+24 more)
...
Cohesion: 0.07
Nodes (29): 0.19.1, 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.10.1, 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 154 - "Community 154"
Cohesion: 0.07
Nodes (27): 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.07
Nodes (8): IndexerIOSim, IndexerIOTalonFX, IndexerIO, ModuleIO, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.13
Nodes (26): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 6. Backup and Restore (+18 more)
...
Cohesion: 0.2
Nodes (3): codeContainerName(), containerRuntimeState(), dockerPortBindError()
...
Cohesion: 0.14
Nodes (3): FlywheelIO, HoodIOSim, HoodIO
...
Cohesion: 0.19
Nodes (3): HopperSubsystem, KickerIO, SpindexerIO
...
Cohesion: 0.15
Nodes (18): 5. Configuration, code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/) (+10 more)
...
Cohesion: 0.24
Nodes (17): 7. Cache Cleanup, Admin status API, code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+9 more)
...
Cohesion: 0.33
Nodes (7): code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), Dev (one-command), One-command start, Production, Verify the app is running
...
## Knowledge Gaps
- **6781 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6776 more)
...
- **Why does `Robot` connect `Community 45` to `Community 0`, `Community 37`, `Community 168`, `Community 360`, `Community 83`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 34` to `Community 24`, `Community 25`, `Community 23`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 95` to `Community 360`?**
