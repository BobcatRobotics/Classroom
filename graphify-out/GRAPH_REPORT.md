# Graph Report - CodeRunner  (2026-09-03)

## Corpus Check
- 1100 files · ~763,526 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25998 nodes · 49080 edges · 2589 communities (1850 shown, 739 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 467 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d31194e4`
...
- `Rename` --calls--> `restoreProjectArchive()`  [INFERRED]
  data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0/document/_java.learnMoreAboutRefactorings.md → apps/control/src/app.ts
- `Headless Gradle Init Script (Team Import)` --semantically_similar_to--> `HALSIM_EXTENSIONS Empty on Later Run (log)`  [INFERRED] [semantically similar]
...
- **Headless Gradle Override Mechanism (Sim GUI Removal)** — authoring_modules_gradle_override, team_import_gradle_init_script, wpilibtoollog_halsim_extensions_empty [INFERRED 0.85]
- **Discard-on-Switch Workspace Pattern** — overview_discard_on_switch, team_import_discard_workspace, faq_lesson_switch_discard [INFERRED 0.85]
- **Gradle/WPILib Cache Priming Across Build and Runtime** — workspace_image_gradle_cache_layer, faq_gradle_cache, faq_first_run_slowness [INFERRED 0.80]

## Communities (2589 total, 739 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (54): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+46 more)
...
Cohesion: 0.0
Nodes (9): Command, RobotContainer, ArcadeDrive, DriveDistance, DriveTime, DriveToPoseCommand, TurnTime, m_autoTime() (+1 more)
...
Cohesion: 0.01
Nodes (9): ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), RomiDrivetrain, log(), SubsystemBase() (+1 more)
...
Cohesion: 0.01
Nodes (20): DefaultDrive, Execute(), DriveCommands, WheelRadiusCharacterizationState, DoubleSupplier, DriveIOSpark, ModuleIOSpark, SparkOdometryThread (+12 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (219): AppSocket, bashCalls, cloneCall, ctx, importer, mock, row, workspace (+211 more)
...
Cohesion: 0.03
Nodes (28): ArmSimulationTest, TEST_P(), AlertTest, AllianceTest, AutonomousTest, DigitalCommunicationTest, EnabledTest, TEST_P() (+20 more)
...
Cohesion: 0.03
Nodes (133): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+125 more)
...
Cohesion: 0.02
Nodes (117): ControlApp, ControlAppOptions, getDemoSessionResponseBody(), seedDemoUser(), input, stripped, apiError(), apiErrorResponse() (+109 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (39): codeContainerName(), CodeContainerStatus, containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), DockerCommandResult (+31 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (71): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+63 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (14): DriveIOSim, DriveIOTalonFX, DriveIOTalonSRX, DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIOTalonFX (+6 more)
...
Cohesion: 0.04
Nodes (51): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+43 more)
...
Cohesion: 0.03
Nodes (4): AssistedDriveCommand, DriveSubsystem, round, GeometryUtil
...
Cohesion: 0.04
Nodes (77): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, DISABLED_DISK_LIMIT_VALUES (+69 more)
...
Cohesion: 0.03
Nodes (7): SysIDCommands, FlywheelIOSim, FlywheelIO, HoodIOSim, HoodIO, ShooterSubsystem, AimHoodAndSpinFlywheelCommand

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (45): DEFAULT_PORT, GamepadLease, GamepadLeaseResolver, GamepadMessageOutcome, GamepadSessions, GamepadStatus, halsimTarget(), log (+37 more)
...
Cohesion: 0.04
Nodes (47): DemoBanner(), EditorPane(), EditorPaneProps, PathPlannerPane, PathPlannerPaneProps, first, frame, { rerender } (+39 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (50): aliceRun, assert(), assertNt4AliveProbe(), assertSimProcessAlive(), bobRun, brokenAlice, fileUri(), initializeLspSession() (+42 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (44): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar(), TopbarProps, AutoPanel() (+36 more)
...
Cohesion: 0.05
Nodes (40): BINDING_GROUPS, bp(), Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton() (+32 more)
...
Cohesion: 0.06
Nodes (34): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps (+26 more)
...
Cohesion: 0.04
Nodes (39): 0.12.2 - 2018-9-6, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17 (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+33 more)
...
Cohesion: 0.04
Nodes (49): 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+41 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (39): 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.1, 0.31.1, 0.33.1, 0.35.1 (+31 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.3 (+39 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.1 (+39 more)
...
Cohesion: 0.07
Nodes (35): PANEL_IDS, SimPanePanels(), SimPanePanelsProps, SimPaneSwitcher(), SimPaneSwitcherProps, SimPaneTab, SimPaneTabs(), SimPaneTabSelector() (+27 more)
...
Cohesion: 0.08
Nodes (24): ImportManager, ImportRateLimiter, backupsDir, bobCookie, body, clearedCache, cloneCall, cookie (+16 more)
...
Cohesion: 0.07
Nodes (28): ConsolePane(), ConsolePaneProps, CATALOG, fetchMock, { result }, useLessons(), UseLessonsReturn, INITIAL_STATE (+20 more)
...
Cohesion: 0.1
Nodes (15): consumeLines(), defaultRunCommandFactory(), dockerRunScript(), lineLooksReady(), log, randomRunId(), RunCommand, RunCommandContext (+7 more)
...
Cohesion: 0.07
Nodes (28): MODE_CLASSES, MODE_LABELS, ModeColumn(), ModeColumnProps, SimButton(), SimButtonProps, SimControlsBlock(), SimControlsBlockProps (+20 more)
...
Cohesion: 0.13
Nodes (37): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+29 more)
...
Cohesion: 0.07
Nodes (29): 0.18.9, 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.18.9, 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 138 - "Community 138"
Cohesion: 0.07
Nodes (27): 0.21.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.07
Nodes (27): 0.10.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1, 0.26.2 (+16 more)
...
Cohesion: 0.11
Nodes (14): BundledCatalogSource, CatalogManifest, CatalogSource, createCatalogSource(), findModuleOrThrow(), log, parseCatalogRepo(), RemoteCatalogSource (+6 more)
...
Cohesion: 0.13
Nodes (25): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App, 5. Configuration, 7. Cache Cleanup (+17 more)
...
Cohesion: 0.09
Nodes (4): ax(), bv(), clamp(), TurretIOSim
...
Cohesion: 0.12
Nodes (6): FakeSocket, Listener, { rerender }, { result }, { unmount }, FakeWebSocket
...
Cohesion: 0.14
Nodes (13): seedRuntimeMissing(), seedRuntimeRunning(), snapshot, cookie, frames, snap, status, body (+5 more)
...
Cohesion: 0.14
Nodes (16): Bundled Lesson Catalog (/opt/frc-catalog), Authoring Custom Lessons / LESSONS_CATALOG_REPO, First Build/Run Warm-up Explanation, Student GitHub Push (Team Import), Lesson Switch Discards Workspace, Switch Project Surface, Team Import Git Push Capability, Per-Student Workspace Isolation (+8 more)
...
Cohesion: 0.21
Nodes (14): 3. Starting the App, code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), Dev (one-command) (+6 more)
...
Cohesion: 0.17
Nodes (13): Example Curriculum Progression, Non-Destructive Headless Gradle Override, plain-java Lesson Kind, robot Lesson Kind, launch.json Run Configuration, modules.json Manifest, Module Fields (id/title/subdir/kind/order), README.md as Lesson Text (+5 more)

### Community 553 - "Community 553"
Cohesion: 0.17
Nodes (13): Cloud Hosting Cost Estimate, Caddy (Auto-TLS), Cost and Sizing, Data Disk (prevent_destroy), docker compose Stack (control/caddy/alloy), c4-standard-4 GCE VM, Grafana Alloy, Hyperdisk-Balanced Disks (+5 more)
...
Cohesion: 0.23
Nodes (12): 6. Backup and Restore, code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir>), Create a backup (+4 more)
...
Cohesion: 0.18
Nodes (12): CodeRunner, Isolated Per-Student Docker Workspace, Lessons and Team Projects, Live Telemetry via AdvantageScope, One-Click Simulation & Driver Station, Self-Hosted, Modest to Run, Browser VS Code Editor (VSCodium), AdvantageScope Telemetry View (+4 more)
...
Cohesion: 0.2
Nodes (10): deploy-cloudflare Job, CF_ACCOUNT_ID / CF_API_TOKEN, Deploy Workflow (deploy.yml), Multi-Arch Images (amd64+arm64), coderunner rebuild-workspaces, Release Workflow (release.yml), Rollback via Redeploy Tag, Workload Identity Federation (+2 more)

### Community 638 - "Community 638"
Cohesion: 0.2
Nodes (10): Switching Modules Discards Workspace, Lessons Are Gitless, build.gradle Verification, git clone --no-single-branch --depth 1 Process, Import Constraints & Limits Table, Switching Away Discards Import Workspace, Team Import Flow, Push Authentication (PAT/SSH) (+2 more)
...
Cohesion: 0.33
Nodes (9): code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), Retention and pruning, Runtime override (admin) (+1 more)
...
Cohesion: 0.25
Nodes (9): Demo Mode (CODERUNNER_DEMO_MODE), First Build/Run Slowness, Primed Gradle/WPILib Dependency Cache, GitHub/Google OAuth Sign-in, Offline Operation Capability, Offline / No-Internet Operation, Student OAuth Accounts & Allowlist, wpilibsuite.vscode-wpilib 2026.1.1 (+1 more)

### Community 656 - "Community 656"
Cohesion: 0.28
Nodes (9): Cloudflare Offline Page, Capacity Planning Doc Reference, CODE_MEMORY_LIMIT Env Var, Hardware Sizing Guidance, Google Cloud Deployment, Local Deployment, Network Safety (Plain HTTP), Deployment Overview (+1 more)
...
Cohesion: 0.29
Nodes (7): Changing control-plane env vars, code:bash (sudo /opt/coderunner/render-env.sh && sudo systemctl restart), code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.3.0), code:bash (printf '<new value>' | gcloud secrets versions add coderunne), First-deploy gotcha, How releases deploy, Rollback
...
Cohesion: 0.29
Nodes (7): coderunner-lessons Example Repo, Publishing via LESSONS_CATALOG_REPO, LESSONS_CATALOG_REPO (FAQ mention), Bundled Catalog Source, 60-Second Catalog Cache, Remote Catalog Source, Switch Project Menu (Lessons + Team Import)

### Community 722 - "Community 722"
Cohesion: 0.29
Nodes (7): Red Hat Java / Java Test Duplicate ASM Bundles, Editor Acceptance Smoke (e2e:workspace-java), WPILib Vendor Dependencies Activity Smoke Case, ./gradlew build Invocations (log), HALSIM_EXTENSIONS Empty on Later Run (log), WPILib Java Simulate Launch Config (log), simulateExternalJavaRelease Gradle Task (log)
...
Cohesion: 0.5
Nodes (3): Project files, Reloading files, Using PathPlanner
...
## Knowledge Gaps
- **6908 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6903 more)
...
- **Why does `Robot` connect `Community 53` to `Community 0`, `Community 358`, `Community 588`, `Community 142`, `Community 79`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 79` to `Community 16`, `Community 22`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 87` to `Community 588`?**
