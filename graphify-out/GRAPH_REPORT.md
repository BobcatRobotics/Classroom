# Graph Report - CodeRunner  (2026-08-26)

## Corpus Check
- 1743 files · ~1,308,337 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24114 nodes · 46899 edges · 2373 communities (1709 shown, 664 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27946367`
...
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
...
## Communities (2373 total, 664 thin omitted)
...
Cohesion: 0.0
Nodes (9): Command, ReplaceMeCommand, ArcadeDrive, DriveDistance, DriveTime, TurnTime, m_autoTime(), ShootIfReadyCommand (+1 more)
...
Cohesion: 0.01
Nodes (14): ShootUntilHopperEmptyCommand, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand, m_autoDistance(), RobotContainer(), InstantCommand, ReplaceMeInstantCommand, RobotContainer (+6 more)
...
Cohesion: 0.01
Nodes (201): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), DockerRunner (+193 more)
...
Cohesion: 0.03
Nodes (82): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+74 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (76): sendUpstreamWebSocketMessage(), createWebSocketHandlers(), log, WebSocketHandlerContext, upstreamEndpoints(), first, NUM_RUNS, second (+68 more)
...
Cohesion: 0.03
Nodes (93): handleUploadAsset(), userAssetsPath(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), input, stripped, apiError() (+85 more)
...
Cohesion: 0.03
Nodes (46): DEFAULT_PORT, GamepadLease, GamepadLeaseResolver, GamepadMessageOutcome, GamepadSessions, GamepadStatus, halsimTarget(), log (+38 more)
...
Cohesion: 0.04
Nodes (75): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange (+67 more)
...
Cohesion: 0.06
Nodes (72): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+64 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (54): pillVariant(), StatusStrip(), StatusStripProps, AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStationProps, MODE_LABELS (+46 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (53): ConsolePane(), ConsolePaneProps, DemoBanner(), EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, patchCall (+45 more)
...
Cohesion: 0.05
Nodes (6): DoubleSupplier, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, Drive, SparkUtil
...
Cohesion: 0.06
Nodes (31): BINDING_GROUPS, Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton() (+23 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (6): HopperSubsystem, KickerIOSim, KickerIO, LEDSubsystem, SpindexerIOSim, SpindexerIO
...
Cohesion: 0.07
Nodes (4): ExtensionIO, IntakeSubsystem, RollerIO, SimShotVisualizer

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (39): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17 (+31 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.31.3, 0.33.1, 0.35.1 (+31 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.31.0, 0.31.1 (+39 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.31.0, 0.31.1 (+39 more)
...
Cohesion: 0.07
Nodes (31): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, DriverStation(), MatchTimer(), MatchTimerProps, STATION_LABELS (+23 more)
...
Cohesion: 0.06
Nodes (4): AssistedDriveCommand, PathUnderTrenchCommand, round, GeometryUtil
...
Cohesion: 0.07
Nodes (21): RunControls(), RunControlsProps, ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps (+13 more)
...
Cohesion: 0.06
Nodes (3): DriveIOSpark, SpindexerIOSpark, SuperstructureIOSpark
...
Cohesion: 0.06
Nodes (26): AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, LessonLoadSocketData, Nt4SocketData (+18 more)
...
Cohesion: 0.07
Nodes (23): 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)

### Community 141 - "Community 141"
Cohesion: 0.07
Nodes (28): 0.10.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)

### Community 142 - "Community 142"
Cohesion: 0.07
Nodes (27): 0.10.1, 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.07
Nodes (27): 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1, 0.26.2 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.21.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.11
Nodes (17): seedRuntimeMissing(), seedRuntimeRunning(), seedWorkspaceProject(), snapshot, cookie, snapshot, status, wsp (+9 more)
...
Cohesion: 0.1
Nodes (26): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2.7 Measure host resources (+18 more)

### Community 177 - "Community 177"
Cohesion: 0.11
Nodes (24): 1. Clone and set up the repo, 1. Clone the repo, 2. Create your `.env` file, 3. Build the workspace image and web assets, 3. Start the app, 4. Allowlist who can sign in, 4. Sign in as the first admin, 5. Start the app (+16 more)

### Community 178 - "Community 178"
Cohesion: 0.13
Nodes (24): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring (+16 more)
...
Cohesion: 0.09
Nodes (7): Bonus, Intentional Template Contents, Kitbot Controls, Provenance, Steps, Timed Robot, WPILib Java Command Starter Template
...
Cohesion: 0.1
Nodes (19): `bun run e2e`: Playwright mocked tier, `bun run e2e:security`: security E2E tests, `bun run test`: control-plane unit and integration tests, `bun run test:web`: frontend unit and component tests, `bun run verify`: full CI gate, code:bash (bunx playwright install chromium), code:bash (bun run test), code:bash (bun run test:web) (+11 more)
...
Cohesion: 0.12
Nodes (15): About demo mode, code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (CODERUNNER_DOCKER_GID=$(stat -c '%g' /var/run/docker.sock) C), code:bash (CODERUNNER_DEMO_MODE=1 docker compose up), code:powershell ($env:CODERUNNER_DEMO_MODE = "1"; docker compose up), code:bat (set "CODERUNNER_DEMO_MODE=1" && docker compose up), code:bash (docker compose down --remove-orphans), Platform support (+7 more)
...
Cohesion: 0.18
Nodes (5): FakeSocket, Listener, { result }, { unmount }, useRunChannel()
...
Cohesion: 0.15
Nodes (13): Building the image locally, code:bash (bun run docker:build:workspace), code:block2 (docker build -f containers/code/Dockerfile -t ghcr.io/mathew), code:bash (bun run docker:pull:workspace), code:bash (bun run docker:rebuild-workspaces), code:bash (bun run docker:rebuild-workspaces -- --dry-run), code:bash (bun run docker:rebuild-workspaces -- --dry-run), Image size (+5 more)
...
Cohesion: 0.15
Nodes (12): Can CodeRunner run offline or without internet?, Can I write my own lessons?, Can students accidentally break each other's work?, Can students push code to GitHub?, Do students need accounts? What if I just want to try it?, FAQ, How much does cloud hosting cost?, Is a Chromebook sufficient for students? (+4 more)
...
Cohesion: 0.17
Nodes (11): 036 — Editor migration: openvscode-server → VSCodium reh-web, 1. VSCodium `reh-web`, not `code-server`, 2. Stay on the LinuxServer base image, 3. The editor keeps container port 3000, 4. Settings and extension paths do not move, 5. Workspace trust: diagnosed, not fixed, Consequences, Context (+3 more)
...
Cohesion: 0.2
Nodes (11): Architecture at runtime, Changing control-plane env vars, code:block1 (internet ──443──> Caddy (VM) ──:4000──> bun control plane (s), code:bash (sudo /opt/coderunner/render-env.sh && sudo systemctl restart), code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.3.0), CodeRunner GCE Deployment, Cost notes, Rollback (+3 more)
...
Cohesion: 0.2
Nodes (9): AdvantageScope, Components under copyleft licenses, Known sourcing issue, Modifications, openvscode-server and Code – OSS, Summary, Third-Party Notices, VSCodium and Code – OSS (+1 more)
...
Cohesion: 0.22
Nodes (8): Consequences, Context, Decision, Decision 022: Skip Docker smoke tier and import/backup-restore E2E tests, Docker smoke tier — not implemented, Import and backup/restore tests — deferred, Import and backup/restore tests — updated after lessons rework, Status
...
Cohesion: 0.25
Nodes (7): 037 — Workspace cache aliases, extension pins, and trust, 1. Share the primed Gradle distribution with WPILib projects, 2. Prevent gallery resolution from replacing pinned VSIXs, 3. Disable workspace trust in the hosted workbench, code:text (permwrapper -> wrapper), code:text (--disable-workspace-trust), Follow-up: browser-owned settings
...
Cohesion: 0.29
Nodes (6): CodeRunner, Lessons and team projects, Next steps, Self-hosted and modest to run, Video walkthrough, What students get
...
Cohesion: 0.29
Nodes (6): A classroom / LAN machine, A Google Cloud VM (Terraform-automated), Deployment Overview, Optional: Cloudflare offline page, Two supported shapes, What both need
...
Cohesion: 0.29
Nodes (4): 01 - Hello, World, Robot Starter, Running it, Where the code lives
...
Cohesion: 0.33
Nodes (5): Background — verified findings, Follow-ups (senior review, 2026-08-24 — NOT part of this implementation), Global Constraints, Out of scope, VSCodium-web Editor Migration Implementation Plan
...
Cohesion: 0.33
Nodes (6): code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.4.0), code:block19 (deploy/), code:bash (printf '<new value>' | gcloud secrets versions add coderunne), Files, First-deploy gotcha, How releases deploy
...
## Knowledge Gaps
- **5609 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5604 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **664 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 55` to `Community 0`, `Community 35`, `Community 782`, `Community 54`, `Community 442`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 35` to `Community 105`, `Community 18`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 90` to `Community 54`?**
