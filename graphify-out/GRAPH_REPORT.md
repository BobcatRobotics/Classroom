# Graph Report - CodeRunner  (2026-05-29)

## Corpus Check
- 2662 files · ~2,151,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19242 nodes · 36733 edges · 1930 communities (1353 shown, 577 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 399 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d415888`
...
## Communities (1930 total, 577 thin omitted)
...
Cohesion: 0.01
Nodes (8): Command, DriveDistance, DriveTime, DriveToPoseCommand, TurnTime, m_autoTime(), RapidReactCommandBot, SysIdRoutineBot
...
Cohesion: 0.04
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, AutoClosingPair (+221 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (229): AuthenticationProvider, AuthenticationProviderOptions, AuthenticationSession, Breakpoint, CallHierarchyProvider, ChatContext, ChatErrorDetails, ChatFollowup (+221 more)
...
Cohesion: 0.01
Nodes (11): SetBrakeModeCommand, m_autoDistance(), RobotContainer(), InstantCommand, ReplaceMeInstantCommand, RobotContainer, ReplaceMeParallelDeadlineGroup, ParallelRaceGroup (+3 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (169): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+161 more)
...
Cohesion: 0.02
Nodes (12): DoubleSupplier, ModuleIOSpark, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark (+4 more)
...
Cohesion: 0.03
Nodes (8): Main, Main, Main, Main, Main, RobotBase, Main, Main
...
Cohesion: 0.03
Nodes (75): AppSocket, log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls, cloneCall (+67 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (96): handleUploadAsset(), userAssetsPath(), getDemoSession(), getDemoSessionResponseBody(), seedDemoUser(), getSessionFromRequest(), requireAdmin(), requireSession() (+88 more)
...
Cohesion: 0.05
Nodes (78): AdminRouteContext, log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest, contentTypeFor() (+70 more)
...
Cohesion: 0.04
Nodes (64): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+56 more)

### Community 27 - "Community 27"
Cohesion: 0.04
Nodes (5): AssistedDriveCommand, round, line, ChassisTrapezoidalController, GeometryUtil
...
Cohesion: 0.04
Nodes (48): DemoBanner(), EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), patchCall, { result } (+40 more)
...
Cohesion: 0.03
Nodes (11): DriveIOSim, DriveIOSpark, DriveIOTalonFX, DriveIOTalonSRX, DriveIO, GyroIO, SuperstructureIOSim, SuperstructureIOSpark (+3 more)
...
Cohesion: 0.06
Nodes (37): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+29 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (41): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, MODE_CLASSES, MODE_LABELS (+33 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (4): PreSpinFlywheelCommand, ReplaceMeCommand, ArcadeDrive, TurnRightCommand
...
Cohesion: 0.04
Nodes (41): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.30.1, 0.31.1, 0.33.1 (+33 more)
...
Cohesion: 0.07
Nodes (38): handleAdminRoute(), addAllowlistEntry(), AllowlistData, EMPTY, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize() (+30 more)
...
Cohesion: 0.12
Nodes (5): codeContainerName(), dockerError(), LocalDockerRuntimeProvider, runtimeFromLease(), v2LabelsMatch()
...
Cohesion: 0.07
Nodes (24): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimerProps, STATION_LABELS, STATIONS, ImportState (+16 more)
...
Cohesion: 0.09
Nodes (21): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail() (+13 more)
...
Cohesion: 0.08
Nodes (14): FakeSocket, Listener, { result }, { unmount }, useRunChannel(), bridge, enabledDisable, FakeWebSocket (+6 more)
...
Cohesion: 0.07
Nodes (24): 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.11
Nodes (21): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, DockerInspectContainer, labelsMatch(), leaseContainerNameFor(), leasePortFor() (+13 more)
...
Cohesion: 0.2
Nodes (7): containerRuntimeState(), isLoopbackHost(), leaseStateFor(), publishedPortFor(), publishedSimPort(), workspaceHomePath(), workspaceJdtLsDataPath()
...
Cohesion: 0.14
Nodes (8): INITIAL_STATE, ProjectSwapKind, ProjectSwapState, ProjectSwapStatus, FakeSocket, Listener, { result }, UseProjectSwapReturn
...
## Knowledge Gaps
- **4285 isolated node(s):** `nosniff`, `console`, `cookie`, `consoleErrors`, `leaseErrors` (+4280 more)
...
- **Why does `Robot` connect `Community 58` to `Community 0`, `Community 39`, `Community 684`, `Community 206`, `Community 244`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 34` to `Community 19`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 96` to `Community 206`?**
