...
## Corpus Check
- Large corpus: 1120 files · ~707,982 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 25627 nodes · 48500 edges · 2541 communities (1825 shown, 716 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 451 edges (avg confidence: 0.8)
- Token cost: 85,148 input · 0 output
...
## Communities (2541 total, 716 thin omitted)
...
Cohesion: 0.0
Nodes (10): Command, DriveDistance, DriveTime, DriveToPoseCommand, m_autoTime(), RetractIntakeCommand, RapidReactCommandBot, SlowDriveSpeedCommand (+2 more)
...
Cohesion: 0.01
Nodes (223): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+215 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (9): SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, ReplaceMeParallelDeadlineGroup, ParallelRaceGroup, ReplaceMeParallelRaceGroup, RobotContainer (+1 more)
...
Cohesion: 0.02
Nodes (10): Main, Main, Main, Main, Main, Main, Main, RobotBase (+2 more)
...
Cohesion: 0.02
Nodes (13): DoubleSupplier, DriveIOSpark, ModuleIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark (+5 more)
...
Cohesion: 0.03
Nodes (84): body, body, body, body, absolute, refs, headers, received (+76 more)
...
Cohesion: 0.02
Nodes (88): sendUpstreamWebSocketMessage(), createWebSocketHandlers(), log, WebSocketHandlerContext, upstreamEndpoints(), first, NUM_RUNS, second (+80 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (38): codeContainerName(), CodeContainerStatus, containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), dockerError() (+30 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (71): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner() (+63 more)
...
Cohesion: 0.04
Nodes (93): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+85 more)
...
Cohesion: 0.03
Nodes (50): Listener, DEFAULT_PORT, GamepadLease, GamepadLeaseResolver, GamepadMessageOutcome, GamepadSessions, GamepadStatus, halsimTarget() (+42 more)
...
Cohesion: 0.05
Nodes (37): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+29 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (72): toHostPath(), ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange (+64 more)
...
Cohesion: 0.03
Nodes (5): AssistedDriveCommand, ExampleGlobalMeasurementSensor, round, ChassisTrapezoidalController, GeometryUtil
...
Cohesion: 0.05
Nodes (43): BINDING_GROUPS, bp(), Bumper(), bv(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+35 more)
...
Cohesion: 0.06
Nodes (42): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps (+34 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (37): DemoBanner(), EditorPane(), EditorPaneProps, Topbar(), patchCall, { result }, updatedResponse, VALID_RESPONSE (+29 more)
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17 (+31 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (41): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.1 (+41 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (39): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.27.0, 0.30.0, 0.30.1, 0.31.1, 0.33.1 (+31 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.31.0, 0.31.3 (+39 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0 (+39 more)
...
Cohesion: 0.07
Nodes (32): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps (+24 more)
...
Cohesion: 0.05
Nodes (3): GyroIONavX, SparkOdometryThread, VisionIOPhotonVision
...
Cohesion: 0.08
Nodes (26): CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel(), ConsolePanelProps, ConsoleTab (+18 more)
...
Cohesion: 0.07
Nodes (29): 0.18.5, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.1.0 - 2018-10-19, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 154 - "Community 154"
Cohesion: 0.07
Nodes (27): 0.10.1, 0.18.7, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.07
Nodes (27): 0.10.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+19 more)
...
Cohesion: 0.11
Nodes (27): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2.7 Measure host resources (+19 more)
...
Cohesion: 0.13
Nodes (24): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App, 5. Configuration, 8. Monitoring (+16 more)
...
Cohesion: 0.13
Nodes (20): 6. Backup and Restore, code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup) (+12 more)
...
Cohesion: 0.18
Nodes (17): After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples, Rename, Args, dirExists() (+9 more)
...
Cohesion: 0.18
Nodes (5): FakeSocket, { rerender }, { result }, { unmount }, useRunChannel()
...
- **Why does `Robot` connect `Community 56` to `Community 0`, `Community 357`, `Community 43`, `Community 780`, `Community 86`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 156` to `Community 26`, `Community 19`, `Community 22`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 97` to `Community 43`?**
