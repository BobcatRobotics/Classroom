...
## Corpus Check
- 976 files · ~699,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24129 nodes · 46923 edges · 2360 communities (1704 shown, 656 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d191123`
...
## Communities (2360 total, 656 thin omitted)
...
Cohesion: 0.01
Nodes (215): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+207 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (16): DriveCommands, WheelRadiusCharacterizationState, SetBrakeModeCommand, FlywheelIO, HoodIO, InstantCommand, ReplaceMeInstantCommand, RobotContainer (+8 more)
...
Cohesion: 0.03
Nodes (130): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+122 more)
...
Cohesion: 0.03
Nodes (109): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+101 more)
...
Cohesion: 0.04
Nodes (67): listWorkspaceDiskLimitDevices(), parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints(), defaultDockerRunner(), dockerError() (+59 more)
...
Cohesion: 0.04
Nodes (54): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+46 more)
...
Cohesion: 0.04
Nodes (34): bashCalls, cloneCall, ctx, importer, mock, row, workspace, GithubImportContext (+26 more)
...
Cohesion: 0.05
Nodes (5): DoubleSupplier, KickerIOSpark, Drive, TurretIOSpark, SparkUtil
...
Cohesion: 0.04
Nodes (39): 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.32.1 - 2021-03-23, 0.34.0 - 2021-05-26, 0.3.1 - 2017-11-17, 0.40.0 - 2022-03-28, 0.40.1- 2022-04-15 (+31 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (39): 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.31.1, 0.31.3, 0.33.1 (+31 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+39 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.31.0 (+39 more)
...
Cohesion: 0.07
Nodes (27): 0.21.2, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.13
Nodes (24): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App, 5. Configuration, 6. Backup and Restore (+16 more)
...
Cohesion: 0.21
Nodes (13): code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir>) (+5 more)
...
Cohesion: 0.27
Nodes (11): 3. Starting the App, code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), Dev (one-command), One-command start, Production (+3 more)
...
## Knowledge Gaps
- **5617 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5612 more)
...
- **Why does `Robot` connect `Community 47` to `Community 0`, `Community 169`, `Community 780`, `Community 80`, `Community 446`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 90` to `Community 169`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 80` to `Community 18`, `Community 12`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _5617 weakly-connected nodes found - possible documentation gaps or missing edges._
