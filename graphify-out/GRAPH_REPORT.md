# Graph Report - CodeRunner  (2026-08-17)

## Corpus Check
- 1771 files · ~1,329,431 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24003 nodes · 46776 edges · 2345 communities (1686 shown, 659 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7269a5fa`
...
## Communities (2345 total, 659 thin omitted)
...
Cohesion: 0.0
Nodes (11): Command, ReplaceMeCommand, ArcadeDrive, DriveTime, TurnDegrees, TurnTime, RobotContainer, RobotContainer (+3 more)
...
Cohesion: 0.01
Nodes (12): ShootUntilHopperEmptyCommand, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, ParallelDeadlineGroup, ReplaceMeParallelDeadlineGroup (+4 more)
...
Cohesion: 0.04
Nodes (73): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+65 more)
...
Cohesion: 0.03
Nodes (101): handleUploadAsset(), userAssetsPath(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), After, Before, code:java (public class Foo {) (+93 more)
...
Cohesion: 0.03
Nodes (6): OuttakeCommand, IntakeCommand, IntakeControlCommand, MoveIntakeToPositionCommand, RetractIntakeCommand, ShootIfReadyCommand
...
Cohesion: 0.04
Nodes (40): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+32 more)
...
Cohesion: 0.05
Nodes (48): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+40 more)
...
Cohesion: 0.04
Nodes (6): DriveIOSim, DriveIO, GyroIO, RobotContainer, SuperstructureIOTalonFX, SuperstructureIO
...
Cohesion: 0.06
Nodes (5): AssistedDriveCommand, ControllerUtil, getPose(), OverrideUtil, ShootingLocation()

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+31 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30 (+33 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.30.1, 0.31.0, 0.31.1 (+41 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (39): 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.31.0, 0.33.1, 0.35.1, 0.37.1 (+31 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.22.4, 0.24.1, 0.30.0, 0.31.0, 0.31.1, 0.31.3, 0.33.1 (+39 more)

### Community 60 - "Community 60"
Cohesion: 0.05
Nodes (7): IndexerIOSim, IndexerIOTalonFX, IndexerIO, IntakeIOSim, IntakeIOTalonFX, IntakeIOTalonFXDual, IntakeIO
...
Cohesion: 0.05
Nodes (19): ax(), bp(), bv(), FlywheelIOSim, HoodIOSim, GamepadFrame, GamepadInfo, listConnectedGamepads() (+11 more)
...
Cohesion: 0.05
Nodes (3): DriveIOSpark, ExtensionIOSpark, SuperstructureIOSpark

### Community 85 - "Community 85"
Cohesion: 0.09
Nodes (31): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+23 more)
...
Cohesion: 0.1
Nodes (20): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+12 more)
...
Cohesion: 0.08
Nodes (6): ModuleIO, TurretIOSpark, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
## Knowledge Gaps
- **5548 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5543 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **659 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 51` to `Community 0`, `Community 34`, `Community 154`, `Community 444`, `Community 30`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 34` to `Community 10`, `Community 21`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 88` to `Community 30`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _5548 weakly-connected nodes found - possible documentation gaps or missing edges._
