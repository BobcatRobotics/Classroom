# Graph Report - CodeRunner  (2026-06-10)

## Corpus Check
- 2505 files · ~2,002,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19812 nodes · 37323 edges · 1991 communities (1388 shown, 603 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 426 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d69d36c2`
...
1. `main()` - 660 edges
2. `Robot()` - 592 edges
3. `TeleopPeriodic()` - 230 edges
4. `RobotPeriodic()` - 220 edges
5. `DisabledInit()` - 190 edges
6. `TeleopInit()` - 190 edges
7. `Change Log` - 175 edges
8. `AutonomousInit()` - 170 edges
9. `AutonomousPeriodic()` - 170 edges
10. `TestPeriodic()` - 170 edges
...
## Communities (1991 total, 603 thin omitted)
...
Cohesion: 0.01
Nodes (10): ReplaceMeSubsystem, SubsystemBase, log(), output(), val(), DriveSubsystem, SubsystemBase(), RomiDrivetrain (+2 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent (+221 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (229): AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, Breakpoint, BreakpointsChangeEvent, CallHierarchyIncomingCall, CallHierarchyProvider, CancellationError, CancellationToken (+221 more)
...
Cohesion: 0.02
Nodes (166): createWebSocketHandlers(), seedDemoUser(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions (+158 more)
...
Cohesion: 0.03
Nodes (90): webShellResponse(), halsimWebSocketResponse(), HOP_BY_HOP_HEADERS, log, nt4AliveResponse(), nt4WebSocketResponse(), probeVscodeReady(), requestedProtocols() (+82 more)
...
Cohesion: 0.03
Nodes (89): input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside(), AssetManifest, authFromRequest() (+81 more)
...
Cohesion: 0.03
Nodes (86): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+78 more)
...
Cohesion: 0.05
Nodes (54): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+46 more)
...
Cohesion: 0.03
Nodes (8): DriveIOSim, DriveIOTalonFX, DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIOTalonFX, SuperstructureIO

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (43): ConsolePane(), ConsolePaneProps, AutoPanel(), AutoPanelProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+35 more)
...
Cohesion: 0.05
Nodes (41): IDELayout(), IDELayoutProps, FakeResizeObserver, Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, Bumper() (+33 more)
...
Cohesion: 0.06
Nodes (30): BINDING_GROUPS, ControlsPanelProps, StatusTone, TONE_PILL, VisualizerProps, CATALOG, fetchMock, { result } (+22 more)
...
Cohesion: 0.04
Nodes (41): 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+33 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.3.1 - 2017-11-17 (+33 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (7): ModuleIO, TurretIOTalonFX, TurretIO, VisionIOPhotonVision, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision

### Community 50 - "Community 50"
Cohesion: 0.06
Nodes (32): AdminApp(), ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState (+24 more)
...
Cohesion: 0.1
Nodes (25): AdminLayout(), Tab, tabs, useAdminPoll(), Allowlist(), AllowlistData, AuditEntry, AuditLog() (+17 more)
...
Cohesion: 0.12
Nodes (3): ContainerOrchestrator, dockerPortBindError(), portIsFree()
...
Cohesion: 0.14
Nodes (23): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App, 5. Configuration, 6. Backup and Restore (+15 more)

### Community 159 - "Community 159"
Cohesion: 0.15
Nodes (24): 7. Cache Cleanup, 8. Monitoring, Admin status API, code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*) (+16 more)

### Community 162 - "Community 162"
Cohesion: 0.12
Nodes (21): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), dockerError(), DockerInspectContainer, leaseContainerNameFor(), leasePortFor(), LocalDockerRuntimeProviderOptions (+13 more)
...
Cohesion: 0.19
Nodes (8): containerRuntimeState(), isLoopbackHost(), labelsMatch(), leaseStateFor(), publishedPortFor(), publishedSimPort(), workspaceHomePath(), workspaceJdtLsDataPath()
...
Cohesion: 0.09
Nodes (21): Alloy config location, Authentication, Capturing a session on a local deployment, code:block1 (14:23:01.482 INFO  [control.runs]  run started workspaceId=a), code:json ({"timestamp":"2026-05-21T14:23:01.482Z","level":"info","cate), code:bash (bun run start 2>&1 | tee coderunner-$(date +%Y%m%d).log), code:bash (# Manual probe), code:bash (# See all managed containers and their state) (+13 more)
...
Cohesion: 0.09
Nodes (6): Bonus, Intentional Template Contents, Kitbot Controls, Provenance, Steps, WPILib Java Command Starter Template
...
Cohesion: 0.16
Nodes (22): 11. Lessons and Project Import, 11. Project Import, code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap) (+14 more)
...
Cohesion: 0.13
Nodes (14): Admin and Metrics, Auth and OAuth, code:bash (bun run start -- --demo), Configuration Reference, Demo mode and the `--demo` flag, Docker and Containers, .env.example vs config.ts — notes, How environment is loaded (+6 more)
...
Cohesion: 0.18
Nodes (10): About demo mode, code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (bun install), code:bash (bun run build), code:bash (bun run start -- --demo), Prerequisites, Quick Start, Steps (+2 more)
...
## Knowledge Gaps
- **4605 isolated node(s):** `nosniff`, `console`, `cookie`, `consoleErrors`, `leaseErrors` (+4600 more)
...
- **Why does `Robot` connect `Community 52` to `Community 0`, `Community 305`, `Community 76`, `Community 121`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 76` to `Community 16`, `Community 18`, `Community 20`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 91` to `Community 238`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
