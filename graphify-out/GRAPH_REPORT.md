...
## Corpus Check
- 2517 files · ~2,094,133 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21551 nodes · 41327 edges · 2084 communities (1474 shown, 610 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c5c48b0`
...
## Communities (2084 total, 610 thin omitted)
...
Cohesion: 0.01
Nodes (9): Command, ArcadeDrive, DriveDistance, DriveToPoseCommand, ExampleCommand, TurnTime, m_autoTime(), RapidReactCommandBot (+1 more)
...
Cohesion: 0.01
Nodes (18): DefaultDrive, Execute(), DoubleSupplier, DriveIOSpark, ModuleIOSpark, SparkOdometryThread, ExtensionIOSpark, FlywheelIOSpark (+10 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (180): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, CodeContainerStatus, ContainerOrchestratorOptions (+172 more)
...
Cohesion: 0.02
Nodes (25): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer (+17 more)
...
Cohesion: 0.02
Nodes (4): AutonomousDistance, AutonomousTime, SequentialCommandGroup, ReplaceMeSequentialCommandGroup
...
Cohesion: 0.04
Nodes (104): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+96 more)
...
Cohesion: 0.03
Nodes (101): handleUploadAsset(), userAssetsPath(), getDemoSession(), getDemoSessionResponseBody(), seedDemoUser(), getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost() (+93 more)
...
Cohesion: 0.03
Nodes (69): pillVariant(), StatusStrip(), StatusStripProps, AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation() (+61 more)
...
Cohesion: 0.06
Nodes (40): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+32 more)
...
Cohesion: 0.05
Nodes (64): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+56 more)
...
Cohesion: 0.04
Nodes (59): ANSI, colorize(), configureLogging(), createJsonSink(), createSink(), defaultLogFormat(), formatAttrs(), formatAttrValue() (+51 more)
...
Cohesion: 0.06
Nodes (41): Avatar(), InitialsAvatar(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine() (+33 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (41): ConsolePane(), ConsolePaneProps, DemoBanner(), EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, patchCall (+33 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (36): BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton(), StatusTone (+28 more)
...
Cohesion: 0.08
Nodes (34): AdminLayout(), Tab, tabs, RunControls(), RunControlsProps, Topbar(), TopbarProps, useAdminPoll() (+26 more)
...
Cohesion: 0.04
Nodes (41): 0.18.2 - 2019-07-23, 0.22.2, 0.24.1, 0.30.1, 0.31.0, 0.31.3, 0.33.1, 0.37.1 (+33 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.31.0 (+39 more)
...
Cohesion: 0.07
Nodes (28): 0.10.2, 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 114 - "Community 114"
Cohesion: 0.07
Nodes (27): 0.19.1, 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.07
Nodes (24): 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.17
Nodes (11): AuditActor, AuditEventInput, AuditLogEntry, AuditLogQuery, adminCookie, body, fakeDocker, rows (+3 more)
...
## Knowledge Gaps
- **4869 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+4864 more)
...
- **Why does `Robot` connect `Community 56` to `Community 0`, `Community 40`, `Community 619`, `Community 302`, `Community 245`, `Community 126`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 72` to `Community 16`, `Community 20`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Vision` connect `Community 252` to `Community 172`, `Community 4`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _4869 weakly-connected nodes found - possible documentation gaps or missing edges._
