# Graph Report - CodeRunner  (2026-07-06)

## Corpus Check
- 1020 files · ~774,065 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22799 nodes · 44106 edges · 2240 communities (1566 shown, 674 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5d901f4`
...
1. `main()` - 858 edges
2. `Robot()` - 769 edges
3. `TeleopPeriodic()` - 299 edges
4. `RobotPeriodic()` - 286 edges
5. `DisabledInit()` - 247 edges
6. `TeleopInit()` - 247 edges
7. `AutonomousInit()` - 221 edges
8. `AutonomousPeriodic()` - 221 edges
9. `TestPeriodic()` - 221 edges
10. `DriveSubsystem` - 209 edges
...
## Communities (2240 total, 674 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (26): Robot, Robot, main(), Robot(), shootTrigger(), Robot, Robot, Robot (+18 more)

### Community 1 - "Community 1"
Cohesion: 0.0
Nodes (11): Command, ReplaceMeCommand, DriveDistance, DriveTime, DriveToPoseCommand, TurnRightCommand, m_autoTime(), RetractIntakeCommand (+3 more)
...
Cohesion: 0.01
Nodes (9): ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), Intake, log(), SubsystemBase() (+1 more)
...
Cohesion: 0.01
Nodes (219): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, ContainerOrchestratorOptions, DockerCommandResult (+211 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (12): Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, ReplaceMeParallelDeadlineGroup (+4 more)
...
Cohesion: 0.02
Nodes (117): getDemoSessionResponseBody(), seedDemoUser(), input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside() (+109 more)
...
Cohesion: 0.04
Nodes (108): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+100 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (80): body, body, body, body, absolute, refs, headers, received (+72 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (26): codeContainerName(), containerName(), ContainerOrchestrator, containerRuntimeState(), defaultDockerRunner(), dockerError(), dockerPortBindError(), isLoopbackHost() (+18 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (59): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints(), defaultDockerRunner(), dockerError(), dockerPortBindError() (+51 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (85): toHostPath(), BundledCatalogSource, CatalogManifest, CatalogSource, createCatalogSource(), findModuleOrThrow(), log, parseCatalogRepo() (+77 more)
...
Cohesion: 0.03
Nodes (58): first, NUM_RUNS, second, bashCalls, cloneCall, ctx, importer, mock (+50 more)
...
Cohesion: 0.04
Nodes (7): DoubleSupplier, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, Drive, SparkUtil

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (19): EMPTY, Autonomous(), Disabled(), EndCompetition(), StartCompetition(), Teleop(), Test(), Args (+11 more)
...
Cohesion: 0.03
Nodes (10): DriveIOTalonFX, DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIOTalonFX, SuperstructureIO, TurretIO (+2 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (44): DemoBanner(), EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant() (+36 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (46): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+38 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+33 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (28): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+20 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)
...
Cohesion: 0.04
Nodes (39): 0.1.0 - 2017-12-01, 0.24.1, 0.30.1, 0.31.0, 0.31.1, 0.33.1, 0.35.1, 0.35.2 (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)
...
Cohesion: 0.1
Nodes (42): completionItems(), completionItemsToSuggestions(), documentationToMarkdown(), handleDiagnostics(), hoverContentsToMarkdown(), hoverToMonaco(), isCompletionItem(), isLspDiagnostic() (+34 more)
...
Cohesion: 0.06
Nodes (37): 10. Become the first admin, 10. Promote yourself to admin, 1. Create and configure the GCP project, 2. Create the Terraform state bucket, 3. Configure Terraform variables, 4. Apply Terraform, 5. Populate Secret Manager, 6. Add a DNS A record (+29 more)
...
Cohesion: 0.06
Nodes (5): ax(), bv(), FlywheelIOSim, clamp(), TurretIOSim
...
Cohesion: 0.09
Nodes (25): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+17 more)
...
Cohesion: 0.1
Nodes (30): code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (cd website && bun install && bun run start), code:bash (bun run docs:dev), code:bash (bun run dev:control   # Bun control plane on :4000 with --wa), code:bash (bun run verify        # typecheck + Bun tests + Vitest + Pla), CodeRunner, Commands, Development (+22 more)
...
Cohesion: 0.07
Nodes (29): 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+21 more)
...
Cohesion: 0.07
Nodes (28): 0.18.9, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)

### Community 123 - "Community 123"
Cohesion: 0.07
Nodes (27): 0.21.2, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.07
Nodes (23): 0.10.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.09
Nodes (15): CATALOG, fetchMock, { result }, useLessons(), UseLessonsReturn, INITIAL_STATE, ProjectSwapKind, ProjectSwapState (+7 more)
...
Cohesion: 0.08
Nodes (3): GyroIOPigeon2, PhoenixOdometryThread, VirtualPD
...
Cohesion: 0.18
Nodes (19): Admin status API, code:bash (bun run restore -- <backup-dir>), code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+11 more)
...
Cohesion: 0.16
Nodes (5): Listener, FakeWebSocket, announceChooser(), encodeMsgPack(), FakeWebSocket
...
Cohesion: 0.11
Nodes (17): Capacity and Sizing, Checking disk usage, Cleaning up, code:bash (# Tighter cap for a memory-constrained host), code:block2 (available_for_containers = total_RAM - 4 GB), code:bash (# Per-container CPU and memory (one-shot)), code:bash (# Overall free space), code:bash (bun run docker:cleanup) (+9 more)
...
Cohesion: 0.14
Nodes (13): About demo mode, code:bash (git clone https://github.com/mathewdunne/CodeRunner coderunn), code:bash (CODERUNNER_DEMO_MODE=1 docker compose up), code:bash (bun run setup:demo), code:bash (bun run demo), Platform support, Prerequisites, Quick Start (+5 more)
...
Cohesion: 0.2
Nodes (4): BrowserLspClient, initializeParams(), registerSemanticTokensProvider(), startJavaLsp()
...
Cohesion: 0.23
Nodes (12): 6. Backup and Restore, code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir> --dry-run                   ), Create a backup (+4 more)
...
Cohesion: 0.33
Nodes (5): CodeRunner, Lessons and team projects, Next steps, Self-hosted and modest to run, What students get
...
## Knowledge Gaps
- **5229 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5224 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **674 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 48` to `Community 0`, `Community 134`, `Community 205`, `Community 114`, `Community 185`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 114` to `Community 17`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 83` to `Community 205`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _5229 weakly-connected nodes found - possible documentation gaps or missing edges._
