# Graph Report - CodeRunner  (2026-08-27)

## Corpus Check
- 976 files · ~698,875 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24148 nodes · 46951 edges · 2385 communities (1715 shown, 670 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3f1bd81`
...
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.38.0/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.38.0/document/_java.learnMoreAboutRefactorings.md
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.38.0/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.38.0/document/_java.learnMoreAboutRefactorings.md
...
## Communities (2385 total, 670 thin omitted)
...
Cohesion: 0.0
Nodes (9): StopDrivingCommand, Command, ArcadeDrive, DriveToPoseCommand, TurnTime, RobotContainer, m_autoTime(), RapidReactCommandBot (+1 more)
...
Cohesion: 0.01
Nodes (11): ReplaceMeSubsystem, SubsystemBase, log(), output(), val(), DriveSubsystem, SubsystemBase(), RomiDrivetrain (+3 more)
...
Cohesion: 0.01
Nodes (208): AppSocket, createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, createApp() (+200 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (20): RobotContainer, RobotContainer, RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch (+12 more)
...
Cohesion: 0.04
Nodes (68): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints(), defaultDockerRunner(), dockerError(), dockerPortBindError() (+60 more)
...
Cohesion: 0.04
Nodes (52): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+44 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (80): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, toHostPath(), ControlAppOptions, ControlConfig, defaultContainerUser(), defaultDataDir (+72 more)
...
Cohesion: 0.04
Nodes (57): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, AutoPanel(), AutoPanelProps (+49 more)
...
Cohesion: 0.05
Nodes (49): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+41 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (43): DemoBanner(), EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), patchCall, { result } (+35 more)
...
Cohesion: 0.05
Nodes (33): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton() (+25 more)
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+31 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (39): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.4, 0.24.1, 0.30.1, 0.31.0, 0.31.1, 0.33.1 (+31 more)

### Community 54 - "Community 54"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.1 (+39 more)

### Community 55 - "Community 55"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)
...
Cohesion: 0.06
Nodes (18): ax(), bp(), bv(), GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad (+10 more)
...
Cohesion: 0.07
Nodes (28): 0.10.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)

### Community 140 - "Community 140"
Cohesion: 0.07
Nodes (27): 0.1.0 - 2018-10-19, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.16
Nodes (30): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+22 more)
...
Cohesion: 0.07
Nodes (24): 0.10.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.15
Nodes (22): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration (+14 more)
...
Cohesion: 0.19
Nodes (9): seedRuntimeMissing(), seedRuntimeRunning(), snapshot, body, projectPath, workspace, console_, freshConsole (+1 more)
...
Cohesion: 0.16
Nodes (4): seedWorkspaceProject(), WorkspacePage, status, wsp
...
Cohesion: 0.17
Nodes (11): 037 — Workspace cache aliases, extension pins, and trust, 1. Share the primed Gradle distribution with WPILib projects, 2. Prevent gallery resolution from replacing pinned VSIXs, 3. Disable workspace trust in the hosted workbench, 4. Keep Gradle daemon JVM limits out of the editor setting, 4. Keep Gradle daemon limits out of editor build arguments, 5. Close the workspace-image build follow-ups, Browser-owned settings finding (+3 more)
...
Cohesion: 0.18
Nodes (11): code:markdown (| [openvscode-server](https://github.com/gitpod-io/openvscod), code:markdown (| [VSCodium](https://github.com/VSCodium/vscodium) / Code – ), code:markdown (- **`linuxserver/vscodium-web` container image** — GNU Gener), code:markdown (Merged per-student container for V2. Combines VSCodium reh-w), code:markdown (| Base image | linuxserver/vscodium-web:1.126.04524-ls35 | G), code:markdown (| 3000 | codium-server (HTTP + WebSocket) — overrides the ba), code:markdown (The container uses s6-overlay for process supervision. The u), code:bash (grep -rn "openvscode" README.md .env.example docs/ | grep -v) (+3 more)
...
Cohesion: 0.29
Nodes (6): Background — verified findings, Follow-up disposition (closed 2026-08-26), Follow-ups (senior review, 2026-08-24 — NOT part of this implementation), Global Constraints, Out of scope, VSCodium-web Editor Migration Implementation Plan
...
Cohesion: 0.5
Nodes (4): code:bash (bun run docs:build && grep -rl "vscodium-web-migration" webs), code:bash (git add docs/decisions/036-vscodium-web-migration.md docs/de), code:bash (git add docs/decisions/036-vscodium-web-migration.md docs/de), Task 7: Record decision log 036
...
## Knowledge Gaps
- **5618 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5613 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **670 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 49` to `Community 0`, `Community 450`, `Community 205`, `Community 81`, `Community 153`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 81` to `Community 17`, `Community 27`, `Community 21`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 86` to `Community 205`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _5618 weakly-connected nodes found - possible documentation gaps or missing edges._
