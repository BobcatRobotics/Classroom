# Graph Report - CodeRunner  (2026-08-23)

## Corpus Check
- 1757 files · ~1,302,082 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24015 nodes · 46796 edges · 2358 communities (1703 shown, 655 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0b7832c7`
...
## Communities (2358 total, 655 thin omitted)
...
Cohesion: 0.0
Nodes (7): Command, ArcadeDrive, DriveDistance, DriveToPoseCommand, TurnTime, m_autoTime(), SysIdRoutineBot
...
Cohesion: 0.01
Nodes (213): AppSocket, ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+205 more)
...
Cohesion: 0.02
Nodes (13): DoubleSupplier, DriveIOSpark, ModuleIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, TurretCommands, SpindexerIOSpark (+5 more)
...
Cohesion: 0.04
Nodes (70): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner() (+62 more)
...
Cohesion: 0.03
Nodes (96): getDemoSessionResponseBody(), seedDemoUser(), After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples, Rename (+88 more)
...
Cohesion: 0.04
Nodes (71): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, DISABLED_DISK_LIMIT_VALUES (+63 more)
...
Cohesion: 0.04
Nodes (4): TrenchDuckCommand, ExtensionIOSpark, LaunchCalculator, AllianceFlipUtil
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+31 more)

### Community 57 - "Community 57"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+33 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (39): 0.22.2, 0.30.1, 0.31.1, 0.31.3, 0.33.1, 0.35.2, 0.37.1, 0.38.2 (+31 more)
...
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.24.1, 0.31.0, 0.31.1, 0.31.3, 0.33.1 (+39 more)
...
Cohesion: 0.06
Nodes (19): ax(), bp(), bv(), GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad (+11 more)
...
Cohesion: 0.07
Nodes (27): 0.18.5, 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.12
Nodes (26): 10. Host Sizing, 11. Lessons and Project Import, 11. Project Import, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 4. Stopping the App (+18 more)
...
Cohesion: 0.17
Nodes (26): code:bash (# Container is auto-recreated on next run. If persistent:), code:bash (# Restart the code container), code:bash (# 1. Prune run logs (safest, usually largest)), code:bash (bun run dev:control), code:bash (bun run migrate:status  # verify DB is accessible), code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (docker stats --filter label=frc-sim.managed=true --no-stream) (+18 more)
...
Cohesion: 0.16
Nodes (24): 8. Monitoring, 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token) (+16 more)
...
Cohesion: 0.12
Nodes (6): FakeSocket, Listener, { result }, { unmount }, useRunChannel(), FakeWebSocket
...
Cohesion: 0.14
Nodes (16): DEFAULT_NETWORKS, deriveComposeProject(), deriveContainerUser(), deriveHostDataDir(), deriveNetwork(), inspectFailureMessage(), notDerived(), selfInspect() (+8 more)
...
Cohesion: 0.16
Nodes (11): headers, received, seedRuntimeMissing(), seedRuntimeRunning(), snapshot, body, projectPath, workspace (+3 more)
...
Cohesion: 0.22
Nodes (8): AdvantageScope, Components under copyleft licenses, Known sourcing issue, Modifications, openvscode-server and Code – OSS, Summary, Third-Party Notices, WPILib and vscode-wpilib
...
## Knowledge Gaps
- **5546 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5541 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **655 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 51` to `Community 0`, `Community 34`, `Community 35`, `Community 452`, `Community 742`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 34` to `Community 24`, `Community 20`, `Community 22`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 88` to `Community 35`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _5546 weakly-connected nodes found - possible documentation gaps or missing edges._
