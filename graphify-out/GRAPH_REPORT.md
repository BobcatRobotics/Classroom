# Graph Report - CodeRunner  (2026-07-07)

## Corpus Check
- 1023 files · ~769,660 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 22815 nodes · 44127 edges · 2216 communities (1580 shown, 636 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `665bf0dc`
...
## Communities (2216 total, 636 thin omitted)
...
Cohesion: 0.01
Nodes (8): Command, ArcadeDrive, DriveDistance, DriveTime, DriveToPoseCommand, m_autoTime(), RapidReactCommandBot, SysIdRoutineBot
...
Cohesion: 0.01
Nodes (9): ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), Intake, RomiDrivetrain, log() (+1 more)
...
Cohesion: 0.04
Nodes (102): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+94 more)
...
Cohesion: 0.04
Nodes (65): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), upstreamEndpoints() (+57 more)
...
Cohesion: 0.04
Nodes (72): toHostPath(), ControlConfig, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange (+64 more)
...
Cohesion: 0.05
Nodes (48): ConsolePane(), ConsolePaneProps, Avatar(), InitialsAvatar(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES (+40 more)
...
Cohesion: 0.05
Nodes (39): DemoBanner(), ScopePane, ScopePaneProps, Topbar(), patchCall, { result }, updatedResponse, VALID_RESPONSE (+31 more)
...
Cohesion: 0.06
Nodes (38): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps (+30 more)
...
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26, 0.40.0 - 2022-03-28 (+33 more)
...
Cohesion: 0.04
Nodes (39): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.27.0, 0.30.0, 0.30.1, 0.33.1, 0.37.1, 0.38.2 (+31 more)

### Community 53 - "Community 53"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.31.0 (+39 more)
...
Cohesion: 0.05
Nodes (28): UserMenu(), BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton() (+20 more)
...
Cohesion: 0.05
Nodes (30): sendUpstreamWebSocketMessage(), AppSocket, createWebSocketHandlers(), log, WebSocketHandlerContext, BundledCatalogSource, CatalogManifest, CatalogSource (+22 more)
...
Cohesion: 0.08
Nodes (19): CATALOG, fetchMock, { result }, useLessons(), UseLessonsReturn, INITIAL_STATE, ProjectSwapKind, ProjectSwapState (+11 more)
...
Cohesion: 0.17
Nodes (5): MecanumControllerCommandTest, TEST_F(), PotentiometerPIDTest, TEST_F(), Thread
...
Cohesion: 0.15
Nodes (16): body, body, body, body, absolute, refs, test, cookieHeader() (+8 more)
...
Cohesion: 0.07
Nodes (29): 0.21.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+21 more)
...
Cohesion: 0.14
Nodes (14): headers, received, seedRuntimeMissing(), seedRuntimeRunning(), seedWorkspaceProject(), cookie, frames, snap (+6 more)
...
Cohesion: 0.26
Nodes (15): code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), code:bash (# Latest entries) (+7 more)
...
## Knowledge Gaps
- **5239 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+5234 more)
...
- **Why does `Robot` connect `Community 45` to `Community 0`, `Community 35`, `Community 135`, `Community 170`, `Community 465`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 87` to `Community 465`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 35` to `Community 16`, `Community 19`, `Community 62`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _5239 weakly-connected nodes found - possible documentation gaps or missing edges._
