# Graph Report - CodeRunner  (2026-09-01)

## Corpus Check
- 997 files · ~722,054 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25854 nodes · 48789 edges · 2598 communities (1846 shown, 752 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a811772c`
...
## Communities (2598 total, 752 thin omitted)
...
Cohesion: 0.01
Nodes (4): Command, DriveDistance, DriveToPoseCommand, m_autoTime()
...
Cohesion: 0.01
Nodes (218): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), DockerRunner (+210 more)
...
Cohesion: 0.02
Nodes (76): sendUpstreamWebSocketMessage(), createWebSocketHandlers(), log, WebSocketHandlerContext, first, NUM_RUNS, second, bashCalls (+68 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (83): body, body, body, body, absolute, refs, headers, received (+75 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (111): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+103 more)
...
Cohesion: 0.03
Nodes (100): handleUploadAsset(), userAssetsPath(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), After, Before, code:java (public class Foo {) (+92 more)
...
Cohesion: 0.04
Nodes (81): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+73 more)
...
Cohesion: 0.04
Nodes (6): DoubleSupplier, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, Drive, TurretIOSpark, SparkUtil
...
Cohesion: 0.05
Nodes (37): DemoBanner(), EditorPane(), EditorPaneProps, patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers() (+29 more)
...
Cohesion: 0.07
Nodes (3): OperatorPanel, Turret, getAngularExitVelocity()

### Community 47 - "Community 47"
Cohesion: 0.05
Nodes (31): ConsolePane(), ConsolePaneProps, BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+23 more)

### Community 50 - "Community 50"
Cohesion: 0.05
Nodes (5): ControlConstants, TunableControlConstants, TunableControls, TunablePIDController, TunableProfiledController
...
Cohesion: 0.1
Nodes (7): ContainerOrchestrator, dockerError(), dockerPortBindError(), portIsFree(), publishedPortFor(), workspaceHomePath(), workspaceJdtLsDataPath()
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23 (+31 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (41): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+33 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.24.1, 0.27.0, 0.30.1, 0.31.0, 0.31.1, 0.31.3, 0.35.1 (+41 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (39): 0.15.1 - 2019-03-19, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.35.1 (+31 more)

### Community 61 - "Community 61"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.31.0, 0.31.1 (+39 more)
...
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)
...
Cohesion: 0.06
Nodes (36): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, onSetEnabled, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS (+28 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (36): ListBlockDevicesOptions, listWorkspaceDiskLimitDevices(), log, IdleManager, IdleManagerOptions, log, ANSI, colorize() (+28 more)
...
Cohesion: 0.06
Nodes (25): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+17 more)
...
Cohesion: 0.09
Nodes (6): AppStorage, ensureWorkspaceFiles(), nowIso(), projectPathFor(), randomId(), slugFromDisplayName()
...
Cohesion: 0.08
Nodes (3): SystemChecks, Intake, Intakes
...
Cohesion: 0.06
Nodes (23): 0.10.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)

### Community 136 - "Community 136"
Cohesion: 0.06
Nodes (4): IndexerIOSim, IndexerIOTalonFX, IndexerIO, PhoenixUtil
...
Cohesion: 0.07
Nodes (28): 0.18.7, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+20 more)
...
Cohesion: 0.1
Nodes (25): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor() (+17 more)
...
Cohesion: 0.07
Nodes (24): 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+16 more)
...
Cohesion: 0.13
Nodes (25): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration (+17 more)
...
Cohesion: 0.17
Nodes (24): code:bash (# Restart the code container), code:bash (# 1. Prune run logs (safest, usually largest)), code:bash (bun run dev:control), code:bash (bun run migrate:status  # verify DB is accessible), code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (CODE_MEMORY_LIMIT=2048m) (+16 more)
...
Cohesion: 0.14
Nodes (4): getHoodAngle(), getLinearExitVelocity(), TurretCalculator, TurretVisualizer

### Community 218 - "Community 218"
Cohesion: 0.09
Nodes (6): ModuleIOTalonFX, ModuleIO, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.14
Nodes (15): bp(), GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad, { result }, useGamepad() (+7 more)
...
Cohesion: 0.2
Nodes (8): PANEL_IDS, SimPaneSwitcher(), SimPaneSwitcherProps, SimPaneTab, TAB_IDS, pathplannerTab, [scopePanel, pathplannerPanel], scopeTab
...
Cohesion: 0.2
Nodes (11): Example Curriculum Progression, plain-java Lesson Kind, robot Lesson Kind, launch.json Run Configuration, modules.json Manifest, Module Fields (id/title/subdir/kind/order), README.md as Lesson Text, Lessons Repository Layout (+3 more)
...
Cohesion: 0.22
Nodes (9): Non-Destructive Headless Gradle Override, Headless Gradle Init Script (Team Import), Red Hat Java / Java Test Duplicate ASM Bundles, Editor Acceptance Smoke (e2e:workspace-java), WPILib Vendor Dependencies Activity Smoke Case, ./gradlew build Invocations (log), HALSIM_EXTENSIONS Empty on Later Run (log), WPILib Java Simulate Launch Config (log) (+1 more)
...
Cohesion: 0.5
Nodes (3): PathPlannerPane, PathPlannerPaneProps, frame
...
## Knowledge Gaps
- **6894 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6889 more)
...
- **Why does `Robot` connect `Community 55` to `Community 0`, `Community 35`, `Community 40`, `Community 460`, `Community 792`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 35` to `Community 24`, `Community 20`, `Community 22`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 97` to `Community 40`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _6894 weakly-connected nodes found - possible documentation gaps or missing edges._
