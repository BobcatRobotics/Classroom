...
## Corpus Check
- 989 files · ~709,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 25559 nodes · 48432 edges · 2539 communities (1829 shown, 710 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 445 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `13daf362`
...
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_f6d1f8e4abd2fc37025e4d17cac5648c/home/extensions/redhat.java-1.55.0/document/_java.learnMoreAboutRefactorings.md
...
## Communities (2539 total, 710 thin omitted)
...
Cohesion: 0.0
Nodes (12): Command, ReplaceMeCommand, RobotContainer, DriveTime, DriveToPoseCommand, TurnTime, RobotContainer, m_autoTime() (+4 more)
...
Cohesion: 0.01
Nodes (216): ascopeRoot, assert(), createCatalogDir(), createTemplate(), distDir, exists(), patchDir, repoRoot (+208 more)
...
Cohesion: 0.02
Nodes (120): handleUploadAsset(), userAssetsPath(), getDemoSession(), getDemoSessionResponseBody(), seedDemoUser(), getSessionFromRequest(), requireAdmin(), requireSession() (+112 more)
...
Cohesion: 0.04
Nodes (65): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+57 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (97): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+89 more)
...
Cohesion: 0.04
Nodes (8): DoubleSupplier, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, Drive, SparkUtil

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (44): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+36 more)
...
Cohesion: 0.04
Nodes (41): DemoBanner(), EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, patchCall, { result }, updatedResponse (+33 more)
...
Cohesion: 0.05
Nodes (45): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun() (+37 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (6): DriveIOSim, DriveIO, GyroIO, RobotContainer, SuperstructureIOSim, SuperstructureIO

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (5): PreSpinFlywheelCommand, SysIDCommands, FlywheelIO, HoodIO, ShooterSubsystem
...
Cohesion: 0.04
Nodes (15): AdminApp(), ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState (+7 more)
...
Cohesion: 0.04
Nodes (39): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+31 more)

### Community 59 - "Community 59"
Cohesion: 0.04
Nodes (41): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+33 more)
...
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+41 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (39): 0.1.0 - 2017-12-01, 0.22.2, 0.24.1, 0.27.0, 0.30.0, 0.31.1, 0.31.3, 0.33.1 (+31 more)

### Community 63 - "Community 63"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+39 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (47): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.31.1, 0.31.3 (+39 more)
...
Cohesion: 0.05
Nodes (20): ax(), bp(), bv(), FlywheelIOSim, HoodIOSim, GamepadFrame, GamepadInfo, listConnectedGamepads() (+12 more)
...
Cohesion: 0.05
Nodes (4): DriveCommands, WheelRadiusCharacterizationState, SparkOdometryThread, TunableDouble
...
Cohesion: 0.07
Nodes (27): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar(), TopbarProps, AllianceStation (+19 more)
...
Cohesion: 0.07
Nodes (29): 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+21 more)
...
Cohesion: 0.07
Nodes (27): 0.18.7, 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+19 more)
...
Cohesion: 0.12
Nodes (27): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 6. Backup and Restore (+19 more)
...
## Knowledge Gaps
- **6752 isolated node(s):** `console`, `cookie`, `consoleErrors`, `leaseErrors`, `dangerous` (+6747 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **710 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 57` to `Community 0`, `Community 69`, `Community 38`, `Community 782`, `Community 275`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 92` to `Community 24`, `Community 19`, `Community 22`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 97` to `Community 69`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **What connects `console`, `cookie`, `consoleErrors` to the rest of the system?**
  _6752 weakly-connected nodes found - possible documentation gaps or missing edges._
